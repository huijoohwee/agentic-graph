...
- [x] 9. Add deterministic flight-envelope guidance
  ...
  - [x] Read the live mission-stage preparation request after render so Geo and connected Motion Control handoffs cannot lose Flight entry to mount ordering.
