...
export const APPLE_SENSOR_CONTROLLER_SCHEMA = 'knowgrph.apple-sensor-controller/v1' as const
...
export class BrowserAppleSensorController {
  ...
  constructor(options: BrowserAppleSensorControllerOptions = {}) {
    ...
    this.reportSubscriberError = options.onSubscriberError
      ?? (error => console.error('[knowgrph] Apple sensor subscriber failed', error))
