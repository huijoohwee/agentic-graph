// Evidence_Pack display view-model for the agentic-graph Cloudflare Pages frontend.
//
// Spec: agentic-graph-acos-mcp-connector, task 7.4 (R1.4; design Correctness
