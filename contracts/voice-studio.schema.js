...
export const VOICE_STUDIO_REQUEST_SCHEMA_VERSION = "agentic-graph-voice-studio-request/v1";
export const VOICE_STUDIO_RESULT_SCHEMA_VERSION = "agentic-graph-voice-studio-result/v1";
export const VOICE_STUDIO_SCHEMA_VERSION = VOICE_STUDIO_REQUEST_SCHEMA_VERSION;
export const VOICE_STUDIO_TOOL_NAME = "agentic-graph.voice.studio";
