...
} from '../agentic-graph-travel-settlement-executor/contract'
import { createSettlementExecutor } from '../agentic-graph-travel-settlement-executor/index'
import type { SettlementExecutorRuntimeEnv } from '../agentic-graph-travel-settlement-executor/upstream'
...
export default defineConfig({
  plugins: [cloudflareTest({
    wrangler: { configPath: './cloudflare/workers/agentic-graph-payment/wrangler.net-settlement.toml' },
    miniflare: {
      serviceBindings: {
  ...
  test: {
    globals: false,
    testTimeout: 15_000,
    include: ['./cloudflare/workers/agentic-graph-payment/__tests__/net-settlement.contract.vitest.ts'],
  },
})
