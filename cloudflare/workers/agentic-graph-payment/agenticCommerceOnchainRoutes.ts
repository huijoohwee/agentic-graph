...
export const settleAgenticCommerceSolanaPaySession = async (
  ...
  await writeTraceEvent(db, {
    ...
    eventType: 'agentic-graph.commerce.solana_pay_confirm',
    payload: {
      tool: 'agentic-graph.commerce.solana_pay_confirm',
...
export const handleAgenticCommerceWeb3Settle = async (
  ...
  await writeTraceEvent(db, {
    sessionId,
    eventType: 'agentic-graph.commerce.web3_confirm',
    payload: { tool: 'agentic-graph.commerce.web3_confirm', session_id: sessionId, tx_hash: txHash, details: confirmation.details || null },
    createdAt: confirmedAt,
  })
  ...
  await writeTraceEvent(db, {
    sessionId,
    eventType: 'agentic-graph.commerce.attest',
    payload: { tool: 'agentic-graph.commerce.attest', session_id: sessionId, tx_hash: txHash, attestation_uid: attestation.attestationUid },
