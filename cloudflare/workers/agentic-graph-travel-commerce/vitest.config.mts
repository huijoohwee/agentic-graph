...
export default defineConfig({
  plugins: [cloudflareTest({
    ...
    wrangler: { configPath: './cloudflare/workers/agentic-graph-travel-commerce/wrangler.jsonc' },
    miniflare: {
      bindings: {
  ...
  test: {
    ...
    testTimeout: 15_000,
    include: ['./cloudflare/workers/agentic-graph-travel-commerce/test/**/*.test.ts'],
  },
})
