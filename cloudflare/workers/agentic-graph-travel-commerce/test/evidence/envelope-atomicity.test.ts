...
import { handleTravelCommerceOfferIngress, TRAVEL_AGENT_OFFERS_PATH } from '../../../agentic-graph-mcp/travel-commerce-ingress.mjs'
// @ts-expect-error The JavaScript Worker module is typechecked by the MCP Worker project.
import { handleTravelCommerceServiceRoute } from '../../../agentic-graph-mcp/travel-commerce-router.mjs'
    ...
    const publicRequest = (authorization: string) => new Request(
      `https://airvio.co${TRAVEL_AGENT_OFFERS_PATH}`,
      {
        ...
        headers: {
          ...
          'x-agentic-graph-component': 'Spoofed_Component',
        },
