...
import sharedCanvasNodeStore from '../../../agentic-graph-storage/sharedCanvasNode/nodeStorage.ts?raw'
import guardrailGate from '../../../agentic-graph-payment/travelAgency/guardrailGate.ts?raw'
import issuanceService from '../../../agentic-graph-payment/travelAgency/issuanceService.ts?raw'
import settlementVerifier from '../../../agentic-graph-payment/travelAgency/settlementVerifier.ts?raw'
  ...
  it('snapshots every inherited interface and captures routeIntent without adding mutation fields', async () => {
    ...
    const registry: Fetcher = {
      async fetch(request: Request) {
        capture.component = request.headers.get('x-agentic-graph-component') ?? ''
...
const REUSED_INTERFACE_BASELINES = Object.freeze([
  ...
  baseline('Discovery Harnesses', inheritedTravelDocument, 'f9e6c9b1d7e110277138522513ae1d8f952cf49fa12f9c0c938eeb8c1c391d79'),
  ...
  baseline('Notification Dispatcher', inheritedTravelDocument, 'f9e6c9b1d7e110277138522513ae1d8f952cf49fa12f9c0c938eeb8c1c391d79'),
  ...
  baseline('Inherited Component Inventory', inheritedCommerceDocument, '4d79306694991dd3d8249b442712b915c6b2f36b65d35e833ba811e4fd29d992'),
])
