export const STORAGE_RELAY_API_VERSION = 'agentic-graph-storage-relay/v1'
...
export const assertDevStorageRelayRequest = (
  ...
  if (env.AGENTIC_OS_STORAGE_DEV_REMOTE_RELAY_ENABLED !== 'true') {
...
export const assertLoopbackStorageRelayRequest = (
  request: Request,
  env: { AGENTIC_OS_STORAGE_LOCAL_RUNTIME?: string } = {},
): void => {
  let requestUrl: URL
  try {
  ...
  const isExplicitLocalRuntime = env.AGENTIC_OS_STORAGE_LOCAL_RUNTIME === 'true'
