...
export const AGENTIC_OS_KNOWLEDGE_SOURCE_ALLOWLIST_SCHEMA =
  'agentic-graph-knowledge-source-allowlist/v1' as const
...
export type KnowledgeSourceAllowlist = {
  schema: typeof AGENTIC_OS_KNOWLEDGE_SOURCE_ALLOWLIST_SCHEMA
  revision: string
  digest: string
