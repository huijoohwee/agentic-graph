...
import {
  AGENTIC_OS_KNOWLEDGE_SOURCE_ALLOWLIST_SCHEMA,
...
export const readKnowledgeSourceAllowlist = async (
  ...
  const encoded = readKnowledgeSourceText(env.AGENTIC_OS_STORAGE_LARK_SOURCE_ALLOWLIST_JSON)
  ...
  if (
    ...
    || parsed.schema !== AGENTIC_OS_KNOWLEDGE_SOURCE_ALLOWLIST_SCHEMA
  ...
  const normalized = { schema: AGENTIC_OS_KNOWLEDGE_SOURCE_ALLOWLIST_SCHEMA, revision, sources }
