export const TRAVEL_AGENT_OFFERS_PATH = "/agentic-os/control-plane/agents/travel-offers";
...
export async function handleTravelCommerceOfferIngress(
  ...
  const headers = new Headers({ "x-agentic-graph-component": "Edge_Orchestrator" });
