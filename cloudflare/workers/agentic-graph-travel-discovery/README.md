# agentic-graph travel discovery provider

This service-binding-only Worker adapts the Atlas/aTriptech Search and Verify
APIs to `agentic-graph.travel-discovery/v1`. It never returns synthetic inventory or
...
The route catalogue is a JSON object keyed by agentic-graph leg ID. Each value must
