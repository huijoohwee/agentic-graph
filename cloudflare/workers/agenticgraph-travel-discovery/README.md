# AgenticGraph travel discovery provider

This service-binding-only Worker adapts the Atlas/aTriptech Search and Verify
APIs to `agenticgraph.travel-discovery/v1`. It never returns synthetic inventory or
...
The route catalogue is a JSON object keyed by AgenticGraph leg ID. Each value must
