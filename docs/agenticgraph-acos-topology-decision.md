...
superseded_by:
  - "docs/documents/agenticgraph-architecture-decisions.md#adr-002--reference-implementation-compose-one-client-before-adding-service-tiers"
  - "docs/documents/agenticgraph-architecture-decisions.md#adr-003--reference-implementation-separate-discovery-local-embedded-and-control-transports"
  - "docs/documents/agenticgraph-architecture-decisions.md#adr-006--reference-implementation-protect-exact-state-promotion"
---
