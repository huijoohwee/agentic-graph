---
title: "Reference implementation: AgenticGraph Design Document"
...
doc_path: "docs/agenticgraph-design-document.md"
canonical_docs_root: "docs/documents"
generator_owner: "canvas/src/cli/lint-doc.ts"
---

# Reference implementation: AgenticGraph Design Document
...
Canonical design documentation lives in `docs/documents/agenticgraph-design-document.md`.
