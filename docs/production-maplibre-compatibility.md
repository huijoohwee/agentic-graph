...
exports. The old distribution import resolves to that same source entry through
the existing Vite alias, preserving one runtime instance. The dependency security candidate must include this compatibility commit
