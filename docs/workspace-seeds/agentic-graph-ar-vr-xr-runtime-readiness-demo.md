...
markdownVariableChoices:
  kgXrMotionReference.stageId: {"label":"Scene","options":[{"value":"tropical-playground","label":"Tropical Playground"},{"value":"singapore","label":"Singapore"},{"value":"neutral-volume","label":"Neutral Volume"}]}
  kgXrMotionReference.subjects.0.assetId: {"label":"Visitor","options":[{"value":"character-wolf","label":"wolf","bindings":{"kgXrMotionReference.subjects.0.label":"The Wolf"}},{"value":"character-monkey","label":"monkey","bindings":{"kgXrMotionReference.subjects.0.label":"The Monkey"}},{"value":"character-pig","label":"pig","bindings":{"kgXrMotionReference.subjects.0.label":"The Pig"}}]}
  kgXrMotionReference.subjects.1.assetId: {"label":"First sailor","options":[{"value":"character-pig","label":"first pig","bindings":{"kgXrMotionReference.subjects.1.label":"First Pig"}},{"value":"character-monkey","label":"first monkey","bindings":{"kgXrMotionReference.subjects.1.label":"First Monkey"}},{"value":"character-wolf","label":"first wolf","bindings":{"kgXrMotionReference.subjects.1.label":"First Wolf"}}]}
  kgXrMotionReference.subjects.2.assetId: {"label":"Second sailor","options":[{"value":"character-pig","label":"second pig","bindings":{"kgXrMotionReference.subjects.2.label":"Second Pig"}},{"value":"character-monkey","label":"second monkey","bindings":{"kgXrMotionReference.subjects.2.label":"Second Monkey"}},{"value":"character-wolf","label":"second wolf","bindings":{"kgXrMotionReference.subjects.2.label":"Second Wolf"}}]}
  kgXrMotionReference.subjects.3.assetId: {"label":"Third sailor","options":[{"value":"character-pig","label":"third pig","bindings":{"kgXrMotionReference.subjects.3.label":"Third Pig"}},{"value":"character-monkey","label":"third monkey","bindings":{"kgXrMotionReference.subjects.3.label":"Third Monkey"}},{"value":"character-wolf","label":"third wolf","bindings":{"kgXrMotionReference.subjects.3.label":"Third Wolf"}}]}
  kgXrMotionReference.subjects.4.assetId: {"label":"First house","options":[{"value":"prop-house-straw","label":"straw","bindings":{"kgXrMotionReference.subjects.4.label":"Straw House"}},{"value":"prop-house-stick","label":"sticks","bindings":{"kgXrMotionReference.subjects.4.label":"Sticks House"}},{"value":"prop-house-brick","label":"brick","bindings":{"kgXrMotionReference.subjects.4.label":"Brick House"}}]}
  kgXrMotionReference.subjects.5.assetId: {"label":"Second house","options":[{"value":"prop-house-straw","label":"straw","bindings":{"kgXrMotionReference.subjects.5.label":"Straw House"}},{"value":"prop-house-stick","label":"sticks","bindings":{"kgXrMotionReference.subjects.5.label":"Sticks House"}},{"value":"prop-house-brick","label":"brick","bindings":{"kgXrMotionReference.subjects.5.label":"Brick House"}}]}
  kgXrMotionReference.subjects.6.assetId: {"label":"Third house","options":[{"value":"prop-house-straw","label":"straw","bindings":{"kgXrMotionReference.subjects.6.label":"Straw House"}},{"value":"prop-house-stick","label":"sticks","bindings":{"kgXrMotionReference.subjects.6.label":"Sticks House"}},{"value":"prop-house-brick","label":"brick","bindings":{"kgXrMotionReference.subjects.6.label":"Brick House"}}]}
  kgXrMotionReference.subjects.8.assetId: {"label":"Chimney prop","options":[{"value":"prop-soup-pot","label":"pot of hot soup","bindings":{"kgXrMotionReference.subjects.8.label":"Soup Pot"}},{"value":"prop-ball","label":"beach ball","bindings":{"kgXrMotionReference.subjects.8.label":"Beach Ball"}}]}
kgXrMotionReference:
  ...
  camera:
    ...
    - {"timeSeconds":4.2,"anchorId":"xr-subject:wolf:1","moveId":"orbit-clockwise","rig":"handheld","easing":"linear","settings":{"shot":"medium","orbitX":0.28,"orbitY":-0.16,"focalLengthMm":46,"focusDistanceMeters":6},"label":"Straw threshold","caption":"The {{kgXrMotionReference.subjects.1.assetId}} built a house of {{kgXrMotionReference.subjects.4.assetId}}. A big, hungry {{kgXrMotionReference.subjects.0.assetId}} came and went “HUFF and PUFF!” — and blew it down! The pig ran away, fast, fast, fast."}
    - {"timeSeconds":8.4,"anchorId":"xr-subject:second-pig:1","moveId":"drone-follow","rig":"steadicam","easing":"linear","settings":{"shot":"medium","orbitX":-0.18,"orbitY":-0.2,"focalLengthMm":42,"focusDistanceMeters":6.4},"label":"Stick house","caption":"The {{kgXrMotionReference.subjects.2.assetId}} built a house of {{kgXrMotionReference.subjects.5.assetId}}."}
    ...
    - {"timeSeconds":12.4,"anchorId":"xr-subject:third-pig:1","moveId":"crane-rise","rig":"crane","easing":"linear","settings":{"shot":"wide","orbitX":-0.04,"orbitY":-0.42,"focalLengthMm":35,"focusDistanceMeters":8.5},"label":"Brick house","caption":"The {{kgXrMotionReference.subjects.3.assetId}} was the cleverest sailor of them all. He built a house of {{kgXrMotionReference.subjects.6.assetId}}, strong and solid, right by the sea. The {{kgXrMotionReference.subjects.0.assetId}} huffed. The {{kgXrMotionReference.subjects.0.assetId}} puffed. But the house did not move — not even a little bit!"}
...
Use the inline dropdowns to change the scene, sailors, visitor or props. Their options and bound fields are declared in `markdownVariableChoices`; selecting a choice updates frontmatter through the normal source editor. Nested caption references keep this body unchanged. Animation owns path and character-motion presets. Timeline owns static transforms, mark easing, gait, position, timing, playback, speed, seek and frame-step. Motion Control uses the same selected target and mark; Camera keeps the same anchors; Game Mode suspends and restores the shared world.
