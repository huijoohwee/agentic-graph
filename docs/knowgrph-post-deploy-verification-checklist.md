...
| VCC | Exact invocable check/request | Recorded result | Tested revision and target | Lane | Pass/fail |
|---|---|---|---|---|---|
| `VCC-DELIVERY-PAGES-04` — direct-candidate route, marker, browser, and returning-user checks preserve canonical metadata | `.github/workflows/smoke-test.sh`; `npm run production:fidelity:check`; `npm run production:sw-upgrade:verify` | `.github/workflows/release.yml` run `30871807035` `Human-Authorized Deploy, Verify, And Publish Mirror` passed; candidate deployment `https://50ba5ab2.joohwee.pages.dev` returned matching markers and browser fidelity for source `467e88cdc1be7c56ac07a4d19db6e3f82eda600d`, and returning-user service-worker convergence passed as `revision-upgrade` from `af6a18aea23646115f9db3fd8435f10f1d8c7e35` to `467e88cdc1be7c56ac07a4d19db6e3f82eda600d` with preserved sibling caches and storage. | `467e88cdc1be7c56ac07a4d19db6e3f82eda600d` on `https://50ba5ab2.joohwee.pages.dev/knowgrph/` and `https://joohwee.pages.dev/knowgrph/` | delivery | pass |
| `VCC-DELIVERY-PAGES-05` — public custom-domain browser fidelity from a non-challenged operator network | `RELEASE_SHA=<sha> PRODUCTION_IMMUTABLE_MANIFEST_DIGEST=<digest> npm run production:fidelity:check` | Operator reran `RELEASE_SHA=467e88cdc1be7c56ac07a4d19db6e3f82eda600d PRODUCTION_IMMUTABLE_MANIFEST_DIGEST=eb89fd1a9ef231b7d2a1d4dff3a19954eae5e8f634a5f5a9950fd8cf6f5176f5 npm run production:fidelity:check`; result `{"status":"passed","browserOrigin":"https://airvio.co","markerOrigin":"https://airvio.co","sourceRevision":"467e88cdc1be7c56ac07a4d19db6e3f82eda600d","agenticCanvasOsRevision":"bebda7bfdf3c9b8b2d8f98a2784a57487520abd6","artifactDigest":"941734f2bea30fb28cc790387634630ca01e8b0c5acee06ba7d7d73a73db875f"}`. | `467e88cdc1be7c56ac07a4d19db6e3f82eda600d` on `https://airvio.co/` and `https://airvio.co/knowgrph/` | delivery | pass |
