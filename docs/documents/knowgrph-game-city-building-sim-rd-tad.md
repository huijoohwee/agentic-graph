...
reuses the current authored XR profile and existing Flight projector to derive
phase `stopped` with environment `null`. The shared geospatial publisher uses
