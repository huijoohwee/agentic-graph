# AgenticGraph Schema Configuration Appendix: Tree & Mermaid Density

This appendix is referenced by `agenticgraph-schema-document.md` and keeps the main document ≤ 600 lines.
