...
doc_path: "docs/documents/agentic-graph-mcp/agentic-graph-mcp-service-prd-tad.companion.md"
guideline_version: "1.7.0"
reference_implementation_label: "reference implementation"
parent: "agentic-graph-mcp-service-prd-tad.md"
...
[the service contract](agentic-graph-mcp-service-prd-tad.md). It is not a second
...
`canvas/src/features/agent-ready/agentic-graph-agent-ready-tool-contract.mjs`; the Pages
...
`cloudflare/workers/agentic-graph-mcp/tool-registry.mjs` contains exactly:

1. `agentic-graph.superagent.run`
2. `agentic-graph.video_remix.run`
3. `agentic-graph.video_remix.research`
4. `agentic-graph.video_remix.storyboard`
5. `agentic-graph.video_remix.render`
6. `agentic-graph.video_remix.publish`
7. `agentic-graph.video_remix.checkout`
8. `agentic-graph.run_manifest.note.update`
9. `agentic-graph.os.status`
10. `agentic-graph.agentic_canvas_os.docs.invoke`
...
| Worker transport | `cloudflare/workers/agentic-graph-mcp/index.ts` | Bearer authorization precedes MCP dispatch; session semantics are preserved. |
| Worker registry | `cloudflare/workers/agentic-graph-mcp/tool-registry.mjs` | Exactly 10 unique source tool names. |
