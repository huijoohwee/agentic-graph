...
doc_path: "docs/documents/agentic-graph-mcp/agentic-graph-mcp-service-prd-tad-adr-mvp-gtm.md"
guideline_version: "1.7.0"
reference_implementation_label: "reference implementation"
companion: "agentic-graph-mcp-service-prd-tad-adr-mvp-gtm.companion.md"
traceability:
  prd: "PRD-MCP"
  tad: "TAD-MCP"
...
| `PRD-MCP-03` | Keep app WebMCP at exactly 50 source tools: 31 read-only and 19 guarded controls. | Must |
...
| `PRD-MCP-03` | Given app initialization, when annotations are classified, then 50 tools split into 31 read-only and 19 guarded controls. | `VCC-MCP-02` |
...
| Browser adapter | Runtime registers 50 app tools. | WebMCP; `webMcpRuntime.ts`; browser feature owners. | Emerging browser protocol; app runtime is replaceable. | `spec-complete` | `undocumented` |
...
[the companion](agentic-graph-mcp-service-prd-tad-adr-mvp-gtm.companion.md). Endpoint
...
| Browser client ↔ app runtime | WebMCP typed descriptors | 50-name shared source contract | Typed unavailable/denied error |
...
| Browser reach | Pages reads work in an MCP client; 50-tool WebMCP is app-local. | Separate adapters. | Pages and browser VCCs. |
...
| `VCC-MCP-02` | App WebMCP exposes exactly 50 tools split 31/19. | Run the focused WebMCP runtime test and surface annotation counts. | No duplicate name; one run. | None recorded |
...
All five roles below consume `PLAN-AGENTIC-GRAPH-MCP-SERVICE-PRD-TAD-ADR-MVP-GTM@0.5.2`. Existing source and runtime observations retain their original revisions and scope; this documentation update renews no deployment or demand evidence. The guideline is [v2.7.0](https://github.com/huijoohwee/huijoohwee.github.io/blob/e8d2a10a8d3e5735c43edf350a22523df05fdf91/guidelines/prd-tad-adr-mvp-gtm-guidelines.md); the shared maturity rubric loads on demand.

| Role | Owning content at this revision |
|---|---|
| PRD | [PRD](agentic-graph-mcp-service-prd-tad-adr-mvp-gtm.md#prd) |
| TAD | [TAD](agentic-graph-mcp-service-prd-tad-adr-mvp-gtm.md#tad) |
| ADR | [Architectural decision](agentic-graph-mcp-service-prd-tad-adr-mvp-gtm.md#architectural-decision) |
| MVP | [MVP — reference implementation](agentic-graph-mcp-service-prd-tad-adr-mvp-gtm.md#mvp--reference-implementation) |
| GTM | [GTM — reference implementation](agentic-graph-mcp-service-prd-tad-adr-mvp-gtm.md#gtm--reference-implementation) |
...
Source review is bounded to repository `7fb85741121d8c2886027e4a630d013ba91c1027`. Confirmed: these referenced artifacts exist at that revision: [`canvas/src/features/agent-ready/agentic-graph-agent-ready-tool-contract.mjs`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/canvas/src/features/agent-ready/agentic-graph-agent-ready-tool-contract.mjs), [`cloudflare/pages/agentic-graph-agent-ready.mjs`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/cloudflare/pages/agentic-graph-agent-ready.mjs), [`canvas/src/features/agent-ready/webMcpRuntime.ts`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/canvas/src/features/agent-ready/webMcpRuntime.ts). Their existence does not confirm every behavior asserted by the specification.
