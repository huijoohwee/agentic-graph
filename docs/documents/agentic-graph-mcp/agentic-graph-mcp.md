...
`agentic-graph.control_local_import_url` is the guarded browser-local owner for
...
[the install contract](../agentic-graph-mcp-install-contract.md). Other documents
