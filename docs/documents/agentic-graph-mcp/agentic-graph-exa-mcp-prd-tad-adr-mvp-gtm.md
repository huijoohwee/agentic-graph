...
doc_path: "docs/documents/agentic-graph-mcp/agentic-graph-exa-mcp-prd-tad-adr-mvp-gtm.md"
...
continuity_id: "PLAN-AGENTIC-GRAPH-EXA-MCP-PRD-TAD-ADR-MVP-GTM"
...
| Engage | Copies a config and configures an MCP host. | Host outside agentic-graph | A secret may be pasted into browser state. | Copy only non-secret material. |
...
| Managed 12-month incremental agentic-graph TCO | USD 0 for source-only UI; upstream fees unmeasured | Keep USD 0 until a provider budget is approved. |
...
own a agentic-graph Invocation Register. agentic-graph endpoint selection remains solely
in [the MCP installation contract](../agentic-graph-mcp-install-contract.md).
...
agentic-graph route ownership. No separate provider endpoint register is authored
here.
...
All five roles below consume `PLAN-AGENTIC-GRAPH-EXA-MCP-PRD-TAD-ADR-MVP-GTM@0.4.1`. Existing source and runtime observations retain their original revisions and scope; this documentation update renews no deployment or demand evidence. The guideline is [v2.7.0](https://github.com/huijoohwee/huijoohwee.github.io/blob/e8d2a10a8d3e5735c43edf350a22523df05fdf91/guidelines/prd-tad-adr-mvp-gtm-guidelines.md); the shared maturity rubric loads on demand.

| Role | Owning content at this revision |
|---|---|
| PRD | [PRD](agentic-graph-exa-mcp-prd-tad-adr-mvp-gtm.md#prd) |
| TAD | [TAD](agentic-graph-exa-mcp-prd-tad-adr-mvp-gtm.md#tad) |
| ADR | [Architectural decision](agentic-graph-exa-mcp-prd-tad-adr-mvp-gtm.md#architectural-decision) |
| MVP | [MVP — reference implementation](agentic-graph-exa-mcp-prd-tad-adr-mvp-gtm.md#mvp--reference-implementation) |
| GTM | [GTM — reference implementation](agentic-graph-exa-mcp-prd-tad-adr-mvp-gtm.md#gtm--reference-implementation) |
...
Source review is bounded to repository `7fb85741121d8c2886027e4a630d013ba91c1027`. Confirmed: these referenced artifacts exist at that revision: [`grph-shared/src/search/exaMcpSsot.ts`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/grph-shared/src/search/exaMcpSsot.ts), [`grph-shared/src/search/exaSearchApiSsot.ts`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/grph-shared/src/search/exaSearchApiSsot.ts), [`canvas/src/features/panels/views/exaSearchApiDocs.ts`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/canvas/src/features/panels/views/exaSearchApiDocs.ts). Their existence does not confirm every behavior asserted by the specification.
