# AgenticGraph Schema Configuration Architecture
...
**Schema-Config**: `data/config/schema/agenticgraph-example-workflow-schema-config.jsonld`
...
```typescript
{
  ...
  schemaPath: "data/config/schema/agenticgraph-example-workflow-schema-config.jsonld"
}
```
...
**Template Location**: `data/config/schema/agenticgraph-schema-config-template.jsonld`
**Metadata Fields**:
```yaml
...
```
See [agenticgraph-schema-document.tree-mermaid-appendix.md](agenticgraph-schema-document.tree-mermaid-appendix.md).
