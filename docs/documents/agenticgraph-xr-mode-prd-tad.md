---
title: "AgenticGraph XR Mode PRD & TAD"
doc_type: "PRD+TAD"
doc_id: "KXR-001"
version: "0.6.1"
...
# AgenticGraph XR Mode PRD & TAD

## Decision

XR Mode is the existing AgenticGraph 3D canvas, workspace asset path, and
...
`docs/documents/agenticgraph-ar-vr-xr-prd-tad-adr.md`. The focused acceptance
boundary is
...
1. The entry owner publishes `agenticgraph-xr-capability-snapshot/v1`.
...
`agenticgraph-ar-vr-xr-prd-tad-adr.md`. XR Mode consumes that contract; it does not
