...
## Reference implementation: Knowgrph source matrix
...
- Parent: `docs/documents/knowgrph-agent-ready-prd-tad.md`
- Source-owner appendix: `docs/documents/knowgrph-agent-ready-prd-tad.companion.md`
- Install/Invocation authority: `docs/documents/knowgrph-mcp-install-contract.md`
- Delivery verification: `docs/knowgrph-post-deploy-verification-checklist.md`
