---
title: "AgenticGraph Mobile-First Enhancement Plan"
...
# AgenticGraph Mobile-First Enhancement Plan
...
- `$GITHUB_ROOT/huijoohwee/content/agenticgraph`
- `airvio.co/agenticgraph`
...
- `agenticgraph/canvas/src/pages/Canvas.tsx`
- `agenticgraph/canvas/src/styles/responsive-toolbar.css`
- `agenticgraph/canvas/src/features/chat/**`
- `agenticgraph/canvas/src/features/markdown-workspace/**`
...
- `agenticgraph/docs/documents/agenticgraph-feature-map.md`
- `agenticgraph/canvas/src/components/CanvasViewport.tsx`
- `agenticgraph/canvas/src/features/markdown/**`
- `agenticgraph/canvas/src/features/three/**`
- `agenticgraph/canvas/src/features/maps/**`
...
- `agenticgraph/agenticgraph_parser/superagent_responsive.py`
- `agenticgraph/agenticgraph_parser/superagent_harness_test.py`
- `agenticgraph/docs/documents/agenticgraph-superagent-harness.md`
- `agenticgraph/docs/documents/agenticgraph-testing-document.md`
...
- `agenticgraph/docs/documents/agenticgraph-feature-map.md`
- `agenticgraph/docs/documents/agenticgraph-ui-ux-design-document.md`
- `agenticgraph/docs/documents/agenticgraph-cross-repo-publish-topology.md`
...
- The canonical route-and-action matrix now lives in `docs/documents/agenticgraph-feature-map.md`.
...
- `docs/documents/agenticgraph-feature-map.md`
- `docs/documents/agenticgraph-cross-repo-publish-topology.md`
- `docs/documents/agenticgraph-superagent-harness.md`
