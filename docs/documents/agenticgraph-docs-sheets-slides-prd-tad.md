---
title: "AgenticGraph Docs/Sheets/Slides Export"
id: "md:agenticgraph-docs-sheets-slides-prd-tad"
...
doc_path: "docs/documents/agenticgraph-docs-sheets-slides-prd-tad.md"
guidelines_version: "1.4.0"
parent: "agenticgraph"
providers_in_scope: "google-primary, microsoft-fallback"
providers_deferred: "lark (see agenticgraph-risk-copilot-demo.md)"
---

# AgenticGraph Docs/Sheets/Slides Export

## Overview

AgenticGraph now exposes a typed local stdio MCP operation,
...
`agenticgraph-docs-sheets-slides-runtime-readiness.md`.
...
2. The local Node MCP server validates the request and reads at most the bounded
   artifact limit from inside `AGENTICGRAPH_ROOT`. The artifact must begin with
...
AgenticGraph analysis and financial-model outputs are source-visible Markdown, but
...
user or `AGENTICGRAPH_GOOGLE_SHARED_DRIVE_FOLDER_ID`; a generic My Drive folder ID
...
```json
{
  "schema": "agenticgraph-export-publish/v1",
  "artifact_id": "docs/example-financial-plan.md",
  "kind": "spreadsheet",
  "provider": "google",
...
Real-account proof should set `AGENTICGRAPH_EXPORT_FLEET_PATH` to a private temporary
...
`AGENTICGRAPH_EXPORT_MICROSOFT_FALLBACK_ENABLED=false`. Removing credentials disables
...
- `docs/documents/agenticgraph-docs-sheets-slides-runtime-readiness.md`
