---
title: "AgenticGraph Agentic Video Workflow — Reference implementation companion"
id: "md:agenticgraph-agentic-os-video-agent-prd-tad-companion"
...
doc_path: "docs/documents/agenticgraph-agentic-os-video-agent-prd-tad.companion.md"
...
# AgenticGraph Agentic Video Workflow — Reference implementation companion
...
| Field | Rule |
|---|---|
| `schema` | `agenticgraph.video_workflow/v1`. |
...
node --test cloudflare/workers/agenticgraph-mcp/__tests__/tool-registry.test.mjs cloudflare/workers/agenticgraph-mcp/__tests__/mcp-surface-equivalence.test.mjs
