---
title: "agentic-graph Game FPS Runtime Readiness"
...
source_contract: "docs/documents/agentic-graph-game-fps-prd-tad-adr-mvp-gtm.md"
...
# agentic-graph Game FPS Runtime Readiness
...
| Browser WebMCP | Strict `agentic-graph-game-mode-mcp/v1` inspect/control registration and duplicate-binding rejection | passed |
...
| Browser WebMCP | Registered and active with schema `agentic-graph-game-mode-mcp/v1`; duplicate semantic binding rejected |
