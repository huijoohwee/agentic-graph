---
title: "AgenticGraph — AI-assisted Programmatic Video Generation"
id: md:agenticgraph-pitchdeck
author: joohwee
institution: "AgenticGraph — airvio.co/agenticgraph"
date: "2026-04-28"
index:
  legend:
    nodes:
  ...
  mermaid: |
    ...
    flowchart TD
      ...
      subgraph S6["⑦ Differentiation"]
        ...
        D_US["AgenticGraph — automatable + inspectable"]:::insight
      end
...
AgenticGraph is a widget-based node canvas for AI-assisted media pipelines — where the entire text → image → video workflow lives as an inspectable, executable graph.
...
| **AgenticGraph** | **Automatable + Inspectable + Reusable + Visual** | Requires template discipline; early-stage UX |
...
| Deployment | Cloudflare Pages (PWA) — airvio.co/agenticgraph |
...
**Live demo**: airvio.co/agenticgraph
