...
# agentic-graph Token Economics Model — PRD-TAD-ADR-MVP-GTM
...
- Should the renderer extension be served as a portable static artifact or embedded in the agentic-graph React app?
...
| File | Scope |
|---|---|
| `agentic-graph-token-economics-model-prd-tad-adr-mvp-gtm.companion.md` | TAD architecture, component specs, workflows, data flows, deployment strategy, and PRD-to-TAD traceability. |

## Planning revision — reference implementation

All five roles below consume `PLAN-AGENTIC-GRAPH-TOKEN-ECONOMICS-MODEL-PRD-TAD-ADR-MVP-GTM@0.2.1`. Existing source and runtime observations retain their original revisions and scope; this documentation update renews no deployment or demand evidence. The guideline is [v2.7.0](https://github.com/huijoohwee/huijoohwee.github.io/blob/e8d2a10a8d3e5735c43edf350a22523df05fdf91/guidelines/prd-tad-adr-mvp-gtm-guidelines.md); the shared maturity rubric loads on demand.

| Role | Owning content at this revision |
|---|---|
| PRD | [Part 1 — PRD](agentic-graph-token-economics-model-prd-tad-adr-mvp-gtm.md#part-1--prd) |
| TAD | [agentic-graph Token Economics Model — TAD Companion](agentic-graph-token-economics-model-prd-tad-adr-mvp-gtm.companion.md#agentic-graph-token-economics-model--tad-companion) |
| ADR | [Architectural Decisions](agentic-graph-token-economics-model-prd-tad-adr-mvp-gtm.companion.md#architectural-decisions) |
| MVP | [MVP — reference implementation](agentic-graph-token-economics-model-prd-tad-adr-mvp-gtm.md#mvp--reference-implementation) |
| GTM | [GTM — reference implementation](agentic-graph-token-economics-model-prd-tad-adr-mvp-gtm.md#gtm--reference-implementation) |
...
Source review is bounded to repository `7fb85741121d8c2886027e4a630d013ba91c1027`. Confirmed: these referenced artifacts exist at that revision: [`canvas/src/features/parsers/agenticOsSemanticGraph.ts`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/canvas/src/features/parsers/agenticOsSemanticGraph.ts), [`canvas/src/lib/graph/agenticOsSemanticQuery.ts`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/canvas/src/lib/graph/agenticOsSemanticQuery.ts), [`canvas/src/hooks/active-graph-data/workspaceStructuredGraph.ts`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/canvas/src/hooks/active-graph-data/workspaceStructuredGraph.ts). Their existence does not confirm every behavior asserted by the specification.
