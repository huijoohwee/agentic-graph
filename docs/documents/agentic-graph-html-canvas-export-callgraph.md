# agentic-graph HTML Canvas Export Call Graph
...
- Workspace export entrypoint: [exportHtmlCanvasFromWorkspace](file://${AG_GITHUB_ROOT}/agentic-graph/canvas/src/features/markdown-workspace/main/exports/exportHtmlCanvas.ts)
- SVG snapshot + DOM overlay capture: [svgSnapshot.ts](file://${AG_GITHUB_ROOT}/agentic-graph/canvas/src/lib/graph/svgSnapshot.ts)
- Offscreen 2D SVG renderer: [renderGraphCanvasSvgForHtmlExport](file://${AG_GITHUB_ROOT}/agentic-graph/canvas/src/lib/graph/htmlCanvasSvgExport.ts)
- 2D style parity applicator: [useGraphCanvasStyles.ts](file://${AG_GITHUB_ROOT}/agentic-graph/canvas/src/components/GraphCanvas/useGraphCanvasStyles.ts)
- Markdown block SVG overlay injector: [markdownDesignSvgOverlay.ts](file://${AG_GITHUB_ROOT}/agentic-graph/canvas/src/lib/graph/htmlViewer/markdownDesignSvgOverlay.ts)
- Standalone SVG rewrite: [rewriteSvgMarkupForStandaloneHtmlExport.ts](file://${AG_GITHUB_ROOT}/agentic-graph/canvas/src/lib/graph/htmlViewer/rewriteSvgMarkupForStandaloneHtmlExport.ts)
- HTML viewer builder: [graphHtmlViewer.ts](file://${AG_GITHUB_ROOT}/agentic-graph/canvas/src/lib/graph/graphHtmlViewer.ts)
- Standalone export CLI: [export-canvas-html.ts](file://${AG_GITHUB_ROOT}/agentic-graph/canvas/src/cli/export-canvas-html.ts)
