# AgenticGraph Settings Architecture
...
- Workspace artifacts are stored under the repo-local ignored `.agenticgraph-workspace/` root.
...
See continuation in `agenticgraph-settings-document-schema-and-specs.md` for component matrix, schema extraction flow, core setting specifications, testing gates, and anti-pattern constraints.
