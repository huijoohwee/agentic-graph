...
doc_path: "docs/documents/agentic-graph-agent-ready-prd-tad-adr-mvp-gtm.companion.md"
...
[the parent contract](agentic-graph-agent-ready-prd-tad-adr-mvp-gtm.md). It does not own
endpoint invocation.
...
| Remote Worker registry | `cloudflare/workers/agentic-graph-mcp/tool-registry.mjs` | Separate 10-tool source registry; not part of Pages or app WebMCP. |
| Remote Worker transport | `cloudflare/workers/agentic-graph-mcp/index.ts` | Separate delivery, bearer authorization, and preserved MCP session id. |
