# AgenticGraph Graph Data Table (Host) — Canvas Fast Grid
...
- This Graph Data Table is **host-owned** (AgenticGraph) and is **not** the extracted `singabldr` Graph Data Table surface.
...
- `agenticgraph/canvas/src/features/graph-data-table/ui/GraphDataTableFastGrid.tsx`
- `agenticgraph/canvas/src/features/graph-data-table/ui/fast-grid/canvasGridRender.ts`
