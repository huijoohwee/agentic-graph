# Legacy AgenticGraph Site Selection Widget (Retail / Residential) — Geospatial Knowledge Graph (KG)
...
This document specifies a **Retail/Residential Site Selection** feature for **agenticgraph** that:
...
## 2) Architecture fit (agenticgraph reality check)
