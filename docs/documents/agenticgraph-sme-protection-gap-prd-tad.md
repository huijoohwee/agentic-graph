---
title: "AgenticGraph SME Protection Graph — PRD/TAD"
graphId: "md:agenticgraph-sme-protection-gap-prd-tad"
doc_type: "Combined PRD/TAD"
date: "2026-07-13"
lang: "en-US"
schema: "agenticgraph-prd-tad/v1"
...
# AgenticGraph SME Protection Graph
...
| Concern | AgenticGraph owner to reuse | Boundary |
|---|---|---|
...
| Local orchestration | `agenticgraph_parser` SuperAgent harness and local MCP | Dev-only, bounded, typed, and resumable |
...
type ProtectionCompileOutput = {
  schema_version: 'agenticgraph.protection-compile/v1'
  run_manifest: object
