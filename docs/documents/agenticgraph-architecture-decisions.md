...
[storage and synchronization contract](agenticgraph-storage-sync-document.md); they are not repeated as
...
## Reference implementation: AgenticGraph source mapping

- PRD owner: `docs/documents/agenticgraph-prd.md`
- TAD owner: `docs/documents/agenticgraph-tad.md`
...
- Superseded topology archive: `docs/agenticgraph-acos-topology-decision.md`
