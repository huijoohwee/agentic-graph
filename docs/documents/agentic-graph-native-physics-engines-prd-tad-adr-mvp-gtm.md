---
title: "agentic-graph Independent Native 2D And 3D Physics Engines PRD-TAD-ADR-MVP-GTM"
...
protected_pull_request: "https://github.com/huijoohwee/agentic-graph/pull/300"
protected_integration_run: "https://github.com/huijoohwee/agentic-graph/actions/runs/29887624293"
external_reference:
...
## ADR: keep dimension-specific cores separate from presentation

Retain the independent fixed-step 2D and 3D cores and adapt the existing XR persisted world to the canonical 3D owner. A dimension-erasing state model or external compatibility layer would widen the contract beyond the supported geometry and deterministic stepping scope. Rendering, animation clips and gameplay remain with their existing owners. This records the implemented migration and does not claim external-engine parity, articulated robotics or cross-runtime bit identity.
...
|---|---|
| PRD | [Requirements](agentic-graph-native-physics-engines-prd-tad-adr-mvp-gtm.md#requirements) |
| TAD | [Technical architecture](agentic-graph-native-physics-engines-prd-tad-adr-mvp-gtm.md#technical-architecture) |
| ADR | [ADR: keep dimension-specific cores separate from presentation](agentic-graph-native-physics-engines-prd-tad-adr-mvp-gtm.md#adr-keep-dimension-specific-cores-separate-from-presentation) |
| MVP | [MVP — reference implementation](agentic-graph-native-physics-engines-prd-tad-adr-mvp-gtm.md#mvp--reference-implementation) |
| GTM | [GTM — reference implementation](agentic-graph-native-physics-engines-prd-tad-adr-mvp-gtm.md#gtm--reference-implementation) |
