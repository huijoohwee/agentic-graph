...
continuity_id: "PLAN-AGENTIC-GRAPH-SME-PROTECTION-GAP-PRD-TAD-ADR-MVP-GTM"
...
# agentic-graph SME Protection Graph
...
| Concern | agentic-graph owner to reuse | Boundary |
|---|---|---|
...
type ProtectionCompileOutput = {
  schema_version: 'agentic-graph.protection-compile/v1'
  run_manifest: object
...
All five roles below consume `PLAN-AGENTIC-GRAPH-SME-PROTECTION-GAP-PRD-TAD-ADR-MVP-GTM@0.1.1`. Existing source and runtime observations retain their original revisions and scope; this documentation update renews no deployment or demand evidence. The guideline is [v2.7.0](https://github.com/huijoohwee/huijoohwee.github.io/blob/e8d2a10a8d3e5735c43edf350a22523df05fdf91/guidelines/prd-tad-adr-mvp-gtm-guidelines.md); the shared maturity rubric loads on demand.

| Role | Owning content at this revision |
|---|---|
| PRD | [Problem Statement](agentic-graph-sme-protection-gap-prd-tad-adr-mvp-gtm.md#problem-statement) |
| TAD | [Technical Architecture](agentic-graph-sme-protection-gap-prd-tad-adr-mvp-gtm.md#technical-architecture) |
| ADR | [Executive Decision](agentic-graph-sme-protection-gap-prd-tad-adr-mvp-gtm.md#executive-decision) |
| MVP | [MVP Scope](agentic-graph-sme-protection-gap-prd-tad-adr-mvp-gtm.md#mvp-scope) |
| GTM | [GTM — reference implementation](agentic-graph-sme-protection-gap-prd-tad-adr-mvp-gtm.md#gtm--reference-implementation) |
