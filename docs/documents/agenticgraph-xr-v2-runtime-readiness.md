---
title: "AgenticGraph XR v2 — Pinned Runtime-Readiness Evidence"
doc_type: "runtime-readiness"
version: "3.0.0"
date: "2026-08-06"
owner: "AgenticGraph XR runtime"
...
# AgenticGraph XR v2 — Pinned Runtime-Readiness Evidence
...
`agenticgraph-xr-v2-dev-runtime-evidence/v1`, and
...
`agenticgraph-xr-v2-behavior-dispatch-graph/v1`; it cannot silently widen the pinned
interchange shape.
...
Vite without `VITE_AGENTICGRAPH_RUN_READY_DEMO`, opens the editor with
