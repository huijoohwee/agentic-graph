...
doc_path: "docs/documents/agentic-graph-agentic-os-video-agent-prd-tad.companion.md"
...
| Field | Rule |
|---|---|
| `schema` | `agentic-graph.video_workflow/v1`. |
...
node --test cloudflare/workers/agentic-graph-mcp/__tests__/tool-registry.test.mjs cloudflare/workers/agentic-graph-mcp/__tests__/mcp-surface-equivalence.test.mjs
