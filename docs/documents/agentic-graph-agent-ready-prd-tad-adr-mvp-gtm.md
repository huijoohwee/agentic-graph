...
doc_path: "docs/documents/agentic-graph-agent-ready-prd-tad-adr-mvp-gtm.md"
...
[the companion](agentic-graph-agent-ready-prd-tad-adr-mvp-gtm.companion.md). The legacy runtime
...
[the MCP service contract](agentic-graph-mcp/agentic-graph-mcp-service-prd-tad-adr-mvp-gtm.md); this
...
|---|---|
| PRD | [PRD](agentic-graph-agent-ready-prd-tad-adr-mvp-gtm.md#prd) |
| TAD | [TAD](agentic-graph-agent-ready-prd-tad-adr-mvp-gtm.md#tad) |
| ADR | [Decision, quality, and reach](agentic-graph-agent-ready-prd-tad-adr-mvp-gtm.md#decision-quality-and-reach) |
| MVP | [MVP — reference implementation](agentic-graph-agent-ready-prd-tad-adr-mvp-gtm.md#mvp--reference-implementation) |
| GTM | [GTM — reference implementation](agentic-graph-agent-ready-prd-tad-adr-mvp-gtm.md#gtm--reference-implementation) |

## MVP — reference implementation

Reuse the minimum scope, acceptance conditions and component owners identified above. The demonstration must follow the documented entry, permitted action, durable outcome and readback, including its stated failure/recovery path. Use `npm run agent-ready:check` for its actual coverage and the named feature checks in the specification; attach exact source, command, result and authoring/mirror/delivery surface to each VCC before advancing readiness. A source locator or structural check alone proves no user outcome.
