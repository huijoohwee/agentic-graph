---
title: "Reference implementation - agentic-graph Payments - PRD & TAD"
doc_type: "PRD+TAD"
...
ownership_boundaries:
  operator_surface: "docs/documents/agentic-graph-mainpanel-commerce-prd-tad.md"
  acp_web3_proof_runtime: "docs/documents/agentic-graph-agentic-commerce-prd-tad.md"
  stripe_mcp_readiness: "docs/documents/agentic-graph-mcp/agentic-graph-stripe-mcp-service.md"
---

# Reference implementation: agentic-graph Payments PRD/TAD
...
| Operator surface for commerce and payments | `docs/documents/agentic-graph-mainpanel-commerce-prd-tad.md` | MainPanel Commerce remains the canonical operator surface. Payments stays a Commerce subsection and never becomes a top-level tab. |
