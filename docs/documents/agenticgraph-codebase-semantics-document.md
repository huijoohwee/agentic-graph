# AgenticGraph Codebase Semantics: Universal Index-to-Render Specification
...
- Codebase index architecture: [agenticgraph-codebase-index-document.md](agenticgraph-codebase-index-document.md)
- Pipeline overview: [agenticgraph-pipeline-document.md](agenticgraph-pipeline-document.md)
- Renderer behavior: [agenticgraph-renderer-document.md](agenticgraph-renderer-document.md)
