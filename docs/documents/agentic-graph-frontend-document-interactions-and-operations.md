# agentic-graph Frontend Document: Interactions and Operations

Continuation of agentic-graph-frontend-document.md covering canvas-markdown interactions, QA, operations, and directives.
...
- Inserted inline image/video references inside Cards and Widgets render as font-height tokenized thumbnail pills using shared agentic-graph border, panel background, and shadow tokens.
...
└── docs/
    └── documents/
        ├── agentic-graph-design-document.md
        ├── agentic-graph-parser-document.md
