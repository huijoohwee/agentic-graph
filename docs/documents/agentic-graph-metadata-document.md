# agentic-graph Metadata Contracts
...
generatedBy:
  ...
  type: string
  mutability: immutable
  validation: must identify implementation (e.g., "agentic_graph_parser.schema_config")
...
```bash
python -m agentic_graph_parser markdown --input <path/to/doc.md> --print-schema-layers
```
