---
title: "AgenticGraph Modularity PRD/TAD"
doc_type: "Combined PRD/TAD"
id: "agenticgraph-modularity-prd-tad"
version: "1.0.2"
status: "implemented"
created: "2026-05-30"
updated: "2026-06-04"
...
# AgenticGraph Modularity PRD/TAD

## Executive Summary

AgenticGraph modularity is an existing in-repo contract, not a plan to copy four stale component
...
The Dev -> Prod -> Cloudflare rule remains: source changes begin in `agenticgraph`, production mirror
...
AgenticGraph is large because it supports import, workspace editing, Source Files, chat, graph parsing,
...
flowchart LR
  ...
  Pages --> Live["public AgenticGraph route"]
```
...
|---|---|---|
| PRD-MOD-01 | owner map and docs status guard | `docs/documents/agenticgraph-modularity-prd-tad.md`, `docsDocumentsStatusCompliance.test.ts` |
