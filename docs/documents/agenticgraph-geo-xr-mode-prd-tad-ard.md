...
The current AgenticGraph mapping specializes this contract as follows:
...
- regional profile:
  [ADM0 Singapore companion](./agenticgraph-adm0-singapore-prd-tad-ard.companion.md);
- domain consumer:
  [City-Building Simulation PRD/TAD/ADR](./agenticgraph-game-city-building-sim-prd-tad-ard.md).
