# agenticgraph × GrabMaps: Drone Flight Path Animation Overlay (TCO Recommendation)

## Context

- Dev repo: `${AG_GITHUB_ROOT}/agenticgraph` (**MainPanel Maps**)
- Prod artifact mirror: `${AG_GITHUB_ROOT}/huijoohwee/content/agenticgraph`
- Deployment: Cloudflare (`airvio.co/agenticgraph`)
...
## Integration notes for agenticgraph (Dev → Prod → Cloudflare)
