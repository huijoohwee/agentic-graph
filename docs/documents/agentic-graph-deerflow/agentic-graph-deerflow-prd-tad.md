# agentic-graph DeerFlow Integration - PRD & TAD
...
Part II: Technical Architecture Documentation continues in [agentic-graph-deerflow-prd-tad.companion.md](agentic-graph-deerflow-prd-tad.companion.md).
