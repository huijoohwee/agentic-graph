...
| Managed 12-month incremental Knowgrph TCO | USD 0 for config rows; provider charges unmeasured | Require provider budget and ADR before nonzero spend. |
...
This document does not own a Knowgrph Invocation Register. Canonical Knowgrph
