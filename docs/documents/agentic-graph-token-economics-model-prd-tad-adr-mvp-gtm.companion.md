...
parent: "agentic-graph-token-economics-model-prd-tad-adr-mvp-gtm.md"
tags:
  - "token-economics"
  - "tad"
  - "agenticOs"
...
4. **react-force-graph (MIT)**: 3D capable; existing agentic-graph dependency. Heavyweight for a 14-node 2D graph; adds WebGL dependency.
