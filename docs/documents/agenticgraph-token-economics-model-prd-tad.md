---
title: "AgenticGraph Token Economics Model — PRD & TAD"
doc_type: "PRD+TAD"
doc_id: "TEM-001"
version: "0.2.0"
...
# AgenticGraph Token Economics Model — PRD & TAD
...
TEM-E1 (KGC semantic GraphData with typed nodes); TEM-E2 (KGC semantic query helpers for lever lookup); AgenticGraph harness runtime (source of `harness-proof.json`).
...
- Should the renderer extension be served as a portable static artifact or embedded in the AgenticGraph React app?
...
| File | Scope |
|---|---|
| `agenticgraph-token-economics-model-prd-tad.companion.md` | TAD architecture, component specs, workflows, data flows, deployment strategy, and PRD-to-TAD traceability. |
