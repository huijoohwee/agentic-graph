# agentic-graph — Flow Diagrams: Parser Logic, Routing Keys, Diagram Kinds, and Surfaces

**Version**: 2.1.0
**Date**: 2026-06-12
**Status**: Canonical — supersedes `agentic-graph-compute-integrity-document.md` v1.0.0
...
| `agentic-graph-artifact-media-storage-architecture.md` | Storage, replay, Cloudflare + BytePlus + Stripe |
