...
doc_path: "docs/documents/agentic-graph-docs-sheets-slides-prd-tad-adr-mvp-gtm.md"
guidelines_version: "1.4.0"
parent: "agentic-graph"
providers_in_scope: "google-primary, microsoft-fallback"
providers_deferred: "lark (see agentic-graph-risk-copilot-demo.md)"
frontmatter_contract: "required"
continuity_id: "PLAN-AGENTIC-GRAPH-DOCS-SHEETS-SLIDES-PRD-TAD-ADR-MVP-GTM"
...
# agentic-graph Docs/Sheets/Slides Export

## Overview

agentic-graph now exposes a typed local stdio MCP operation,
...
`agentic-graph-docs-sheets-slides-runtime-readiness.md`.
...
2. The local Node MCP server validates the request and reads at most the bounded
   artifact limit from inside `AGENTIC_OS_ROOT`. The artifact must begin with
...
agentic-graph analysis and financial-model outputs are source-visible Markdown, but
...
user or `AGENTIC_OS_GOOGLE_SHARED_DRIVE_FOLDER_ID`; a generic My Drive folder ID
...
```json
{
  "schema": "agentic-graph-export-publish/v1",
  "artifact_id": "docs/example-financial-plan.md",
  "kind": "spreadsheet",
  "provider": "google",
...
Real-account proof should set `AGENTIC_OS_EXPORT_FLEET_PATH` to a private temporary
...
`AGENTIC_OS_EXPORT_MICROSOFT_FALLBACK_ENABLED=false`. Removing credentials disables
...
- `docs/documents/agentic-graph-docs-sheets-slides-runtime-readiness.md`
...
All five roles below consume `PLAN-AGENTIC-GRAPH-DOCS-SHEETS-SLIDES-PRD-TAD-ADR-MVP-GTM@1.1.1`. Existing source and runtime observations retain their original revisions and scope; this documentation update renews no deployment or demand evidence. The guideline is [v2.7.0](https://github.com/huijoohwee/huijoohwee.github.io/blob/e8d2a10a8d3e5735c43edf350a22523df05fdf91/guidelines/prd-tad-adr-mvp-gtm-guidelines.md); the shared maturity rubric loads on demand.

| Role | Owning content at this revision |
|---|---|
| PRD | [PRD](agentic-graph-docs-sheets-slides-prd-tad-adr-mvp-gtm.md#prd) |
| TAD | [TAD](agentic-graph-docs-sheets-slides-prd-tad-adr-mvp-gtm.md#tad) |
| ADR | [Architectural decisions](agentic-graph-docs-sheets-slides-prd-tad-adr-mvp-gtm.md#architectural-decisions) |
| MVP | [MVP — reference implementation](agentic-graph-docs-sheets-slides-prd-tad-adr-mvp-gtm.md#mvp--reference-implementation) |
| GTM | [GTM — reference implementation](agentic-graph-docs-sheets-slides-prd-tad-adr-mvp-gtm.md#gtm--reference-implementation) |
...
Source review is bounded to repository `7fb85741121d8c2886027e4a630d013ba91c1027`. Confirmed: these referenced artifacts exist at that revision: [`mcp/server.js`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/mcp/server.js), [`scripts/fleet.js`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/scripts/fleet.js), [`mcp/export-publish-contract.js`](https://github.com/huijoohwee/agentic-graph/blob/7fb85741121d8c2886027e4a630d013ba91c1027/mcp/export-publish-contract.js). Their existence does not confirm every behavior asserted by the specification.
