---
title: "agentic-graph Pitchdeck Frontmatter Template Contract"
doc_type: "Document"
date: "2026-05-27"
lang: "en-US"
...
# agentic-graph Pitchdeck Frontmatter Template Contract
...
Keep template structure, widget fields, panel writeback, and parser expectations aligned across `agentic-graph`, `huijoohwee.github.io`, and validation fixtures.

## Canonical Artifacts

| Artifact | Role | Directive |
| --- | --- | --- |
| `huijoohwee.github.io/template/pitchdeck-prd-tad-adr-mvp-gtm-template-lite.md` | Minimal reusable template | Keep it frontmatter-first, generic, and parser-safe. |
| `huijoohwee.github.io/template/pitchdeck-prd-tad-adr-mvp-gtm-template.md` | Full reusable template | Keep it frontmatter-first, generic, and parser-safe. |
