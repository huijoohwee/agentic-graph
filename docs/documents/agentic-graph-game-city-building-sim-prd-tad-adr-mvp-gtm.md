...
requirements_authority: "/.kiro/specs/agentic-graph-city-building-sim/requirements.md"
geo_xr_contract: "/docs/documents/agentic-graph-geo-xr-mode-prd-tad-adr-mvp-gtm.md"
regional_profile_companion: "/docs/documents/agentic-graph-adm0-singapore-prd-tad-adr-mvp-gtm.companion.md"
evidence_companion: "/docs/documents/agentic-graph-game-city-building-sim-vcc-delivery.md"
continuity_id: "PLAN-AGENTIC-GRAPH-GAME-CITY-BUILDING-SIM-PRD-TAD-ADR-MVP-GTM"
...
# Reference implementation: agentic-graph City-Building Simulation PRD-TAD-ADR-MVP-GTM
...
The [City Simulation VCC and delivery register](./agentic-graph-game-city-building-sim-vcc-delivery.md)
...
agentic-graph realizes the contract through:
...
- the [ADM0 Singapore companion](./agentic-graph-adm0-singapore-prd-tad-adr-mvp-gtm.companion.md)
...
| `agentic-graph.inspect_local_city_sim` | Tool identity | City embedded-tool owner | empty object | browser-local read | 0 |
| `agentic-graph.control_local_city_sim` | Tool identity | City embedded-tool owner | native invocation or one structured operation | browser-local approval-gated mutation | 0 |
...
All five roles below consume `PLAN-AGENTIC-GRAPH-GAME-CITY-BUILDING-SIM-PRD-TAD-ADR-MVP-GTM@2.1.1`. Existing source and runtime observations retain their original revisions and scope; this documentation update renews no deployment or demand evidence. The guideline is [v2.7.0](https://github.com/huijoohwee/huijoohwee.github.io/blob/e8d2a10a8d3e5735c43edf350a22523df05fdf91/guidelines/prd-tad-adr-mvp-gtm-guidelines.md); the shared maturity rubric loads on demand.

| Role | Owning content at this revision |
|---|---|
| PRD | [2. PRD problem, hypothesis, and outcome](agentic-graph-game-city-building-sim-prd-tad-adr-mvp-gtm.md#2-prd-problem-hypothesis-and-outcome) |
| TAD | [9. TAD architecture and topology](agentic-graph-game-city-building-sim-prd-tad-adr-mvp-gtm.md#9-tad-architecture-and-topology) |
| ADR | [12. ADR-1: source-authored initialization only](agentic-graph-game-city-building-sim-prd-tad-adr-mvp-gtm.md#12-adr-1-source-authored-initialization-only) |
| MVP | [MVP — reference implementation](agentic-graph-game-city-building-sim-prd-tad-adr-mvp-gtm.md#mvp--reference-implementation) |
| GTM | [GTM — reference implementation](agentic-graph-game-city-building-sim-prd-tad-adr-mvp-gtm.md#gtm--reference-implementation) |
