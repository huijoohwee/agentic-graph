...
doc_path: "docs/documents/agentic-graph-agent-ready-prd-tad.md"
...
[the companion](agentic-graph-agent-ready-prd-tad.companion.md). The legacy runtime
...
[the MCP service contract](agentic-graph-mcp/agentic-graph-mcp-service-prd-tad.md); this
