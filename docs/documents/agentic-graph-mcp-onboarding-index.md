...
id: "md:agentic-graph-mcp-onboarding-index"
...
doc_path: "docs/documents/agentic-graph-mcp-onboarding-index.md"
...
[authoritative Invocation Register](agentic-graph-mcp-install-contract.md).
