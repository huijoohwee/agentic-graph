...
doc_path: "docs/documents/agentic-graph-agent-ready-prd-tad.runtime.md"
...
- Parent: `docs/documents/agentic-graph-agent-ready-prd-tad.md`
- Source-owner appendix: `docs/documents/agentic-graph-agent-ready-prd-tad.companion.md`
