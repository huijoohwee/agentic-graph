...
doc_path: "docs/documents/agenticgraph-mcp/agenticgraph-mcp-service-prd-tad.companion.md"
guideline_version: "1.7.0"
reference_implementation_label: "reference implementation"
parent: "agenticgraph-mcp-service-prd-tad.md"
...
[the service contract](agenticgraph-mcp-service-prd-tad.md). It is not a second
...
`canvas/src/features/agent-ready/agenticgraphAgentReadyToolContract.mjs`; the Pages
...
`cloudflare/workers/agenticgraph-mcp/tool-registry.mjs` contains exactly:

1. `agenticgraph.superagent.run`
2. `agenticgraph.video_remix.run`
3. `agenticgraph.video_remix.research`
4. `agenticgraph.video_remix.storyboard`
5. `agenticgraph.video_remix.render`
6. `agenticgraph.video_remix.publish`
7. `agenticgraph.video_remix.checkout`
8. `agenticgraph.run_manifest.note.update`
9. `agenticgraph.os.status`
10. `agenticgraph.agentic_canvas_os.docs.invoke`
...
[the install contract](../agenticgraph-mcp-install-contract.md).
...
|---|---|---|
| Shared tool definitions | `canvas/src/features/agent-ready/agenticgraphAgentReadyToolContract.mjs` | Pages remains the seven-tool read subset; browser totals remain 42. |
| Browser registration | `canvas/src/features/agent-ready/webMcpRuntime.ts` | 30 read-only annotations and 12 guarded controls. |
| Pages adapter | `cloudflare/pages/agenticgraph-agent-ready.mjs` | No guarded controls in Pages tool discovery. |
...
| Worker transport | `cloudflare/workers/agenticgraph-mcp/index.ts` | Bearer authorization precedes MCP dispatch; session semantics are preserved. |
| Worker registry | `cloudflare/workers/agenticgraph-mcp/tool-registry.mjs` | Exactly 10 unique source tool names. |
