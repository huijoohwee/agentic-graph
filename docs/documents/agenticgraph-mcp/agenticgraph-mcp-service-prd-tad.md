...
doc_path: "docs/documents/agenticgraph-mcp/agenticgraph-mcp-service-prd-tad.md"
guideline_version: "1.7.0"
reference_implementation_label: "reference implementation"
companion: "agenticgraph-mcp-service-prd-tad.companion.md"
traceability:
  prd: "PRD-MCP"
  tad: "TAD-MCP"
...
| Pages adapter | Adapter serves seven read-only tools. | HTTP JSON-RPC; `cloudflare/pages/agenticgraph-agent-ready.mjs`. | Open protocol; current edge adapter is a replaceable reference implementation. | `spec-complete` | `undocumented` |
...
[the companion](agenticgraph-mcp-service-prd-tad.companion.md). Endpoint
