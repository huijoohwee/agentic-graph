---
title: "AgenticGraph Apple Spatial Input SSOT Distribution"
...
# AgenticGraph Apple Spatial Input SSOT Distribution

## Root owner

AgenticGraph `packages/apple-spatial-input` is the sole authored TypeScript backend
...
AgenticGraph and GameXR may own different frontend composition, visual assets,
...
exact npm-compatible tarball generated from the AgenticGraph TypeScript package.
...
The GameXR native adapter consumes the AgenticGraph root SwiftPM products at
...
AgenticGraph consumer tests, duplicate-owner guards, Flight readiness checks, and
...
PR #734 is protected-integrated as AgenticGraph revision
...
receipts; they neither republish the AgenticGraph package nor create another backend
owner.
