---
title: "Reference implementation: Superseded AgenticGraph Storage Decision Index"
id: "md:agenticgraph-storage-sync-adrs-document"
...
doc_path: "docs/documents/agenticgraph-storage-sync-adrs-document.md"
document_lifecycle: "superseded"
superseded_by:
  - "docs/documents/agenticgraph-architecture-decisions.md#adr-004--reference-implementation-use-tiered-persistence-roles"
  - "docs/documents/agenticgraph-storage-sync-prd-tad-adr.md#architectural-decision-records"
  - "docs/documents/agenticgraph-artifact-media-storage-architecture.md"
---

# Reference implementation: Superseded AgenticGraph Storage Decision Index
