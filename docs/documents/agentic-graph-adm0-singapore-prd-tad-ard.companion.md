...
|---|---|
| Schema / profile / revision | `agentic-graph.regional-poi-profile/v1` / `adm0:SGP:major-pois/v1` / `2026-07-31.2` |
...
| Generic mode authority | `docs/documents/agentic-graph-geo-xr-mode-prd-tad-ard.md` | shared surface, semantic wrapper, lifecycle, input, camera, and overlay ownership |
| City product authority | `docs/documents/agentic-graph-game-city-building-sim-prd-tad-ard.md` | POI-keyed zoning state, economy, advice, persistence, and City actions |
