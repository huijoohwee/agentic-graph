---
title: "Knowgrph — AI Voice Studio PRD/TAD"
id: "md:knowgrph-ai-voice-studio-prd-tad"
...
traceability:
  ...
  doc_path: "docs/documents/knowgrph-ai-voice-studio-prd-tad.md"
source_references:
...
# Knowgrph — AI Voice Studio PRD/TAD

## Outcome and claim boundary

Knowgrph now owns one provider-neutral voice studio across browser UI and local stdio MCP. It supports three exact intent routes:
...
On 2026-07-24, the Knowgrph-authored Voice Studio contract, runtime, tests,
...
| Knowgrph shared schema | `contracts/voice-studio.schema.js` | Closed input/output schemas and pure validation |
| Local MCP descriptor | `mcp/voice-studio-tool-contract.js` | `knowgrph.voice.studio` |
...
| Registry | Knowgrph vdeoxpln | discoverability and routing metadata |

### MCP operation model

The single MCP tool accepts `operation: clone | dictate | create` using
`knowgrph-voice-studio-request/v1`; results use
`knowgrph-voice-studio-result/v1`.
