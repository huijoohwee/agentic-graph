---
title: "Reference implementation: Knowgrph Technical Architecture"
...
---
# Reference implementation: Knowgrph Technical Architecture
...
[part 2](knowgrph-technical-architecture.settings.md); both parts are refreshed
