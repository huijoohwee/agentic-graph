...
def main(argv: Optional[Sequence[str]] = None, *, base_dir: str) -> int:
    ...
    parser.add_argument(
        "--input",
        "-i",
        default=os.path.join(base_dir, "data", "outputs", "agentic-graph-workflow.json"),
    )
    parser.add_argument(
        "--output-dir",
        "-o",
    ...
    parser.add_argument("--nodes-csv", default="agentic-graph-workflow-nodes.csv")
    parser.add_argument("--edges-csv", default="agentic-graph-workflow-edges.csv")
    parser.add_argument("--summary-json", default="agentic-graph-workflow-summary.json")
