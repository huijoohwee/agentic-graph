...
def tool_skill_select(payload: JsonDict) -> JsonDict:
    ...
    manifest = {
        "schema_version": "agentic-graph.superagent.selected-skills.v1",
...
def tool_research_scout(payload: JsonDict) -> JsonDict:
    ...
    pack = {
        "schema_version": "agentic-graph.superagent.research-pack.v1",
        "run_id": str(payload["run_id"]),
        "title": title,
        "source": {
...
def tool_code_write_and_run(payload: JsonDict) -> JsonDict:
    ...
    summary = {
        "schema_version": "agentic-graph.superagent.generated-code-summary.v1",
        "run_id": str(payload["run_id"]),
        "title": title,
    ...
    try:
        ...
        sandbox = {
            "schema_version": "agentic-graph.superagent.sandbox-result.v1",
            "run_id": str(payload["run_id"]),
            "code_path": code_path,
            "cwd": code_dir,
