...
def append_graphrag_workflow(
    ...
    pipeline_node = ensure_node(document, "agentic_graph_parser/graphrag_pipeline_cmd.py", "File")
    append_relation(pipeline_node, "consumesInput", config_node["@id"])
    append_relation(pipeline_node, "producesOutput", output_node["@id"])
    root_pipeline = ensure_node(document, "agentic_graph_parser/pipeline_cmd.py", "File")
