...
def ensure_harness_proof_manifest_artifact(state: JsonDict, proof_manifest_path: str) -> None:
    ...
    _upsert_artifact(state, {
        ...
        "metadata": {"schema_version": "agentic-graph.superagent.proof.v1"},
    })
...
def build_harness_proof_manifest(
    *,
    ...
    return {
        "schema_version": "agentic-graph.superagent.proof.v1",
        ...
        "harness_contract": {
            ...
            "codex_integration": {
                ...
                "cli": "python3 -m agentic_graph_parser superagent --input <brief.md> --output-dir <run-output-dir>",
                "mcp_tool": "agentic-graph.superagent.run",
                "surface_route": surface_route,
            },
            "capabilities": {
                "task_capabilities": SUPERAGENT_TASK_CAPABILITIES,
                "task_levels": SUPERAGENT_TASK_LEVELS,
                "message_gateway": ["CLI", "local MCP agentic-graph.superagent.run"],
