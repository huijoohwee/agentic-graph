...
async function verifyApexActivation(width) {
  ...
  if (await page.locator('[data-kg-floating-panel-root="true"]').isVisible()) await page.locator('[data-kg-floating-panel-root="true"]').getByRole('button', { name: 'Close', exact: true }).click()
