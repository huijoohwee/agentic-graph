  ...
  const metaEnv = (() => {
    ...
    try {
      return {
        ...
        VITE_AGENTIC_OS_STORAGE_BASE_URL: import.meta.env.VITE_AGENTIC_OS_STORAGE_BASE_URL,
        VITE_AGENTIC_OS_AGENT_READY_BASE_URL: import.meta.env.VITE_AGENTIC_OS_AGENT_READY_BASE_URL,
        VITE_AGENTIC_OS_STORAGE_WORKSPACE_ID: import.meta.env.VITE_AGENTIC_OS_STORAGE_WORKSPACE_ID,
        VITE_AGENTIC_OS_STORAGE_RUNTIME_SYNC_ENABLED: import.meta.env.VITE_AGENTIC_OS_STORAGE_RUNTIME_SYNC_ENABLED,
        VITE_AGENTIC_OS_STORAGE_CHAT_SESSION_TOKEN: import.meta.env.VITE_AGENTIC_OS_STORAGE_CHAT_SESSION_TOKEN,
        VITE_AGENTIC_OS_RUN_READY_DEMO: import.meta.env.VITE_AGENTIC_OS_RUN_READY_DEMO,
        VITE_AGENTIC_OS_RUN_READY_REPO_LOCAL: import.meta.env.VITE_AGENTIC_OS_RUN_READY_REPO_LOCAL,
        VITE_AGENTIC_OS_WORKSPACE_SEEDS_READ_ABS_ROOT: import.meta.env.VITE_AGENTIC_OS_WORKSPACE_SEEDS_READ_ABS_ROOT,
        VITE_AGENTIC_OS_GITHUB_WRITE_BASE_URL: import.meta.env.VITE_AGENTIC_OS_GITHUB_WRITE_BASE_URL,
        VITE_AGENTIC_OS_GITHUB_WRITE_ENABLED: import.meta.env.VITE_AGENTIC_OS_GITHUB_WRITE_ENABLED,
        VITE_AGENTIC_OS_VIDEO_AGENT_VALIDATION_DOC_PATH: import.meta.env.VITE_AGENTIC_OS_VIDEO_AGENT_VALIDATION_DOC_PATH,
        VITE_AGENTIC_OS_VIDEO_AGENT_VALIDATION_URLS: import.meta.env.VITE_AGENTIC_OS_VIDEO_AGENT_VALIDATION_URLS,
        ...
        VITE_WORKSPACE_INITIALIZATION_AGENTIC_CANVAS_OS_DOCS_ABS_ROOT: import.meta.env.VITE_WORKSPACE_INITIALIZATION_AGENTIC_CANVAS_OS_DOCS_ABS_ROOT,
