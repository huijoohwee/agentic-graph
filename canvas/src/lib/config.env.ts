  ...
  const metaEnv = (() => {
    ...
    try {
      return {
        ...
        VITE_AGENTICGRAPH_STORAGE_BASE_URL: import.meta.env.VITE_AGENTICGRAPH_STORAGE_BASE_URL,
        VITE_AGENTICGRAPH_AGENT_READY_BASE_URL: import.meta.env.VITE_AGENTICGRAPH_AGENT_READY_BASE_URL,
        VITE_AGENTICGRAPH_STORAGE_WORKSPACE_ID: import.meta.env.VITE_AGENTICGRAPH_STORAGE_WORKSPACE_ID,
        VITE_AGENTICGRAPH_STORAGE_RUNTIME_SYNC_ENABLED: import.meta.env.VITE_AGENTICGRAPH_STORAGE_RUNTIME_SYNC_ENABLED,
        VITE_AGENTICGRAPH_STORAGE_CHAT_SESSION_TOKEN: import.meta.env.VITE_AGENTICGRAPH_STORAGE_CHAT_SESSION_TOKEN,
        VITE_AGENTICGRAPH_RUN_READY_DEMO: import.meta.env.VITE_AGENTICGRAPH_RUN_READY_DEMO,
        VITE_AGENTICGRAPH_RUN_READY_REPO_LOCAL: import.meta.env.VITE_AGENTICGRAPH_RUN_READY_REPO_LOCAL,
        VITE_AGENTICGRAPH_WORKSPACE_SEEDS_READ_ABS_ROOT: import.meta.env.VITE_AGENTICGRAPH_WORKSPACE_SEEDS_READ_ABS_ROOT,
        VITE_AGENTICGRAPH_GITHUB_WRITE_BASE_URL: import.meta.env.VITE_AGENTICGRAPH_GITHUB_WRITE_BASE_URL,
        VITE_AGENTICGRAPH_GITHUB_WRITE_ENABLED: import.meta.env.VITE_AGENTICGRAPH_GITHUB_WRITE_ENABLED,
        VITE_AGENTICGRAPH_VIDEO_AGENT_VALIDATION_DOC_PATH: import.meta.env.VITE_AGENTICGRAPH_VIDEO_AGENT_VALIDATION_DOC_PATH,
        VITE_AGENTICGRAPH_VIDEO_AGENT_VALIDATION_URLS: import.meta.env.VITE_AGENTICGRAPH_VIDEO_AGENT_VALIDATION_URLS,
