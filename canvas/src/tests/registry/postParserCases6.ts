...
export const TEST_CASES_POST_PARSER_6: TestCaseTuple[] = [
  ...
  ["ui.floatingPanelChat.composer.agenticgraphProbeTreeInvocationGrammar","@/__tests__/agenticOsAgenticGraphDocInvocation.test","testAgenticGraphProbeTreeInvocationGrammarUsesDocAliasesAndToolIdentity"],
  ["ui.storyboardCard.invocationChip.probeTreeStaysOnCanvas","@/__tests__/agenticOsAgenticGraphDocInvocation.test","testStoryboardProbeTreeInvocationChipDoesNotNavigateAwayFromCanvas"],
  ["canvas.storyboardWidget.textPublication.standaloneTerminalGraph","@/__tests__/agenticOsAgenticGraphDocInvocation.test","testTerminalTextPublicationKeepsStandalonePanelAtomic"],
  ["canvas.storyboardWidget.textPublication.staleArtifactRecovery","@/__tests__/agenticOsAgenticGraphDocInvocation.test","testStaleTextPublicationRecoversExistingWorkspaceArtifact"],
  ["canvas.storyboardWidget.run.embeddedProbeTreeInvocation","@/__tests__/agenticOsAgenticGraphDocInvocation.test","testStoryboardWidgetRunMaterializesEmbeddedProbeTreeInvocation"],
  ["canvas.storyboardWidget.probeTree.entrypoints.noConflict","@/__tests__/agenticOsAgenticGraphDocInvocation.test","testProbeTreeToolbarAndSlashRunShareOneIdempotentBranchSet"],
