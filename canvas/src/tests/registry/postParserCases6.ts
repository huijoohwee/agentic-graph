...
export const TEST_CASES_POST_PARSER_6: TestCaseTuple[] = [
  ...
  ["chat.headlessResponse.invocationOverflowFailsClosed","@/__tests__/headlessResponseCoordinator.test","testHeadlessResponseInvocationOverflowFailsBeforeInference"],
  ["chat.headlessResponse.structuredFinalization","@/__tests__/headlessResponseCoordinator.test","testHeadlessResponseFinalizationUsesSharedStructuredProjector"],
  ["chat.headlessResponse.localHistoryPersistence","@/__tests__/headlessResponseCoordinator.test","testHeadlessResponseRunSurvivesLocalChatHistoryProjection"],
  ["chat.headlessResponse.workspaceReceiptPaths","@/__tests__/headlessResponseChatPersistence.test.tsx","testHeadlessChatReceiptsUseResolvedWorkspaceArtifactPaths"],
  ...
  ["storyboardWidget.outputWiring.genericTextFeedsExplicitWidget","@/__tests__/storyboardWidgetHeadlessOutputWiring.test","testGenericTextRunFeedsExplicitWidgetWithoutIntermediatePanel"],
  ["storyboardWidget.outputWiring.typedWidgetAndExplicitPanel","@/__tests__/storyboardWidgetHeadlessOutputWiring.test","testTypedWidgetAndExplicitPanelShareCanonicalSourceProjection"],
  ["storyboardWidget.outputWiring.videoPromptPortPrecedence","@/__tests__/storyboardWidgetTextProjectionTargetPorts.test","testVideoWidgetPromptPortTakesPrecedenceOverPanelProjection"],
  ["storyboardWidget.outputWiring.nonTextPanelPortIsolation","@/__tests__/storyboardWidgetTextProjectionTargetPorts.test","testNonTextPanelPortRejectsTextProjection"],
  ["storyboardWidget.outputWiring.existingOwnedPanelWithWidgetTarget","@/__tests__/storyboardWidgetHeadlessOutputWiring.test","testExistingOwnedPanelStillProjectsWithTypedWidgetTarget"],
  ["storyboardWidget.outputWiring.untypedWidgetKeepsPanelFallback","@/__tests__/storyboardWidgetHeadlessOutputWiring.test","testUntypedWidgetTargetKeepsOwnedPanelFallback"],
  ["storyboardWidget.outputWiring.ownedOutputWithWidgetTarget","@/__tests__/storyboardWidgetHeadlessOutputWiring.test","testOwnedOutputIgnoresTypedWidgetFallbackSuppression"],
  ["storyboardWidget.outputWiring.headlessSingleProviderProjection","@/__tests__/storyboardWidgetHeadlessOutputWiring.test","testHeadlessWidgetRunUsesOneProviderLaneAndCanonicalProjections"],
  ["storyboardWidget.outputWiring.headlessThinkingSeparatePanel","@/__tests__/storyboardWidgetHeadlessOutputWiring.test","testHeadlessWidgetPublishesAvailableThinkingAsSeparateOwnedPanel"],
  ["storyboardWidget.outputWiring.headlessFailurePreservesOutput","@/__tests__/storyboardWidgetHeadlessOutputWiring.test","testHeadlessWidgetFailurePreservesLastGoodOutput"],
  ["storyboardWidget.outputWiring.headlessStreamingFailureTerminates","@/__tests__/storyboardWidgetHeadlessOutputWiring.test","testHeadlessWidgetStreamingFailureClearsTerminalLoading"],
  ["storyboardWidget.outputWiring.genericPromptUsesHeadlessCoordinator","@/__tests__/storyboardWidgetHeadlessOutputWiring.test","testGenericPromptWidgetUsesSharedHeadlessCoordinatorBeforeSourceFallback"],
  ["storyboardWidget.outputLayout.ownedPanelUsesLiveCanonicalAnchor","@/__tests__/storyboardWidgetNaturalLanguageRequest.test","testOwnedRichMediaPanelPlacementUsesLiveCanonicalAnchor"],
  ["storyboardWidget.outputWiring.documentSummaryUsesHeadlessCoordinator","@/__tests__/storyboardWidgetNaturalLanguageRequest.test","testDocumentSummaryUsesSharedHeadlessCoordinatorBeforeSourceFallback"],
  ["storyboardWidget.outputLayout.runMaterializationUsesCapturedExecutionAnchor","@/__tests__/storyboardWidgetNaturalLanguageRequest.test","testRunMaterializationUsesCapturedExecutionAnchorAtNaturalZoom"],
  ["storyboardWidget.outputLayout.heterogeneousProjectionAcrossZoom","@/__tests__/storyboardWidgetNaturalLanguageRequest.test","testHeterogeneousRunMaterializationPreservesRendererProjectionAcrossZoom"],
  ["storyboardWidget.outputLayout.coordinatorFanoutRightwardTopDown","@/__tests__/storyboardWidgetNaturalLanguageRequest.test","testCoordinatorFanoutRunMaterializationPreservesRightwardTopDownTopologyAtNaturalSize"],
  ...
  ["storyboardWidget.edgeAuthoring.multiSourceCohort","@/__tests__/storyboardWidgetMultiConnectSession.test","testStoryboardMultiSourceSelectionArmsOneDeterministicCohort"],
  ["storyboardWidget.edgeAuthoring.multiSourceTargetExclusion","@/__tests__/storyboardWidgetMultiConnectSession.test","testStoryboardMultiSourceSelectionExcludesTargetAndUnselectedPrimaryResetsCohort"],
  ["storyboardWidget.edgeAuthoring.modifierSelectionCohort","@/__tests__/storyboardWidgetMultiConnectSession.test","testStoryboardModifierSelectionForcesCohortWithoutChangingDocumentMode"],
  ...
  ["storyboardWidget.outputGrouping.renderedCollectiveBounds","@/__tests__/storyboardGroupPanelRenderedBounds.test","testGeneratedOutputGroupUsesRenderedCollectiveBounds"],
  ...
  ["chat.run.text.partialLengthTerminalRejected","@/__tests__/byteplusRunTextTerminal.test","testRunTextRejectsPartialAssistantContentWithLengthTerminal"],
  ...
  ["chat.responseContract.prompt.agenticOsComputingFlowKtvShape","@/__tests__/chatResponseAgenticOsComputingFlowContract.test","testChatAgenticOsResponseContractPromptEnforcesComputingFlowShape"],
  ["chat.responseContract.storage.agenticOsComputingFlowKtvBodyTokens","@/__tests__/chatResponseAgenticOsComputingFlowContract.test","testAgenticOsDeterministicFallbackGeneratesComputingFlowKtvBodyTokens"],
  ["chat.responseContract.storage.agenticOsPreservesAssistantAnswerResponseBody","@/__tests__/chatResponseAgenticOsComputingFlowContract.test","testAgenticOsDeterministicFallbackPreservesAssistantAnswerInResponseBody"],
  ["chat.responseContract.storage.agenticOsSubstantiveAnswerResponseOnlyBody","@/__tests__/chatResponseAgenticOsComputingFlowContract.test","testAgenticOsSubstantiveAssistantAnswerUsesResponseOnlyBody"],
  ["chat.responseContract.storage.agenticOsSubstantiveAnswerSeedsRichMediaOutputs","@/__tests__/chatResponseAgenticOsComputingFlowContract.test","testAgenticOsSubstantiveAssistantAnswerSeedsRichMediaOutputs"],
  ["chat.responseContract.storage.agenticOsTraceOnlyNoBackfillBody","@/__tests__/chatResponseAgenticOsComputingFlowContract.test","testAgenticOsDeterministicFallbackTraceOnlyKeepsHumanFacingNoBackfill"],
  ["chat.responseContract.storage.agenticOsNoSlashImageTraceCleanSlate","@/__tests__/chatResponseAgenticOsComputingFlowContract.test","testAgenticOsNoSlashImageTraceKeepsCleanSlateNoBackfill"],
  ["chat.responseContract.storage.agenticOsComputingFlowStripsAppendedCanonicalSections","@/__tests__/chatResponseAgenticOsComputingFlowContract.test","testAgenticOsComputingFlowStripsAppendedCanonicalSections"],
  ...
  ["ui.floatingPanelChat.videoPreset.logsActivationWithoutGeneratedAgenticOs","@/__tests__/floatingPanelChatVideoPreset.test","testFloatingPanelChatVideoPresetLogsActivationWithoutGeneratedAgenticOs"],
  ...
  ["ui.floatingPanelChat.durableResume.headlessReceipt","@/__tests__/floatingPanelChatDurableResume.test","testFloatingPanelChatDurableResumeRestoresBoundedHeadlessReceiptWithoutMcpReplay"],
  ...
  ["ui.floatingPanelChat.composer.agenticGraphProbeTreeInvocationGrammar","@/__tests__/agentic-os-agentic-graph-doc-invocation.test","testAgenticGraphProbeTreeInvocationGrammarUsesDocAliasesAndToolIdentity"],
  ["ui.storyboardCard.invocationChip.probeTreeStaysOnCanvas","@/__tests__/agentic-os-agentic-graph-doc-invocation.test","testStoryboardProbeTreeInvocationChipDoesNotNavigateAwayFromCanvas"],
  ["canvas.storyboardWidget.textPublication.standaloneTerminalGraph","@/__tests__/agentic-os-agentic-graph-doc-invocation.test","testTerminalTextPublicationKeepsStandalonePanelAtomic"],
  ["canvas.storyboardWidget.textPublication.staleArtifactRecovery","@/__tests__/agentic-os-agentic-graph-doc-invocation.test","testStaleTextPublicationRecoversExistingWorkspaceArtifact"],
  ["canvas.storyboardWidget.run.embeddedProbeTreeInvocation","@/__tests__/agentic-os-agentic-graph-doc-invocation.test","testStoryboardWidgetRunMaterializesEmbeddedProbeTreeInvocation"],
  ["canvas.storyboardWidget.probeTree.entrypoints.noConflict","@/__tests__/agentic-os-agentic-graph-doc-invocation.test","testProbeTreeToolbarAndSlashRunShareOneIdempotentBranchSet"],
  ...
  ["storyboardWidget.widget.collision.richMediaWorldGeometryInvalidatesSettlement","@/__tests__/storyboardWidgetDropBalancedCollective.test","testFixedCardCollisionLayoutInvalidatesWhenRichMediaWorldGeometryChanges"],
  ["storyboardWidget.widget.collision.incrementalCardUsesNearestOpenSpace","@/__tests__/storyboardWidgetDropBalancedCollective.test","testIncrementalFixedCardUsesNearestOpenSpaceAroundExpandedRichMedia"],
  ["storyboardWidget.widget.zoomPreset.transientEditorPresentationRebalance","@/__tests__/storyboardWidgetDropBalancedCollective.test","testZoomPresetRebalanceUsesTransientPresentationPositionsDuringEditorGuard"],
  ...
  ["canvas.probeTree.outputLayout.runMaterializationFitsCapturedViewport","@/__tests__/storyboardProbeTreeGrowthLayout.test","testProbeTreeRunMaterializationFitsCapturedVisibleViewport"],
  ["canvas.probeTree.outputLayout.panelPrecedesBranchesIdempotently","@/__tests__/storyboardProbeTreeOutputLayout.test","testProbeTreeOutputPanelPrecedesGrowingBranchColumnsIdempotently"],
  ...
  ["richMedia.probeTree.canonicalProvenanceSelectionFocus","@/__tests__/richMediaPanelWorkspaceViewerPostEditRegression.test.tsx","testRichMediaWorkspaceViewerRevealsCanonicalProvenanceSelection"],
  ...
  ["ui.floatingPanelChat.prdTadSlash.mediaOnlyProviderPayload","@/__tests__/floatingPanelChatPrdTadInvocationContract.test","testFloatingPanelChatPrdTadSlashMediaOnlyProviderPayloadCompilesRoute"],
  ...
  ["chat.responseContract.storage.prdTadSlashTraceResponseOnlyNoBackfill","@/__tests__/floatingPanelChatPrdTadInvocationContract.test","testAgenticOsPrdTadSlashTraceUsesResponseOnlyNoBackfill"],
  ["chat.responseContract.storage.attachedMediaStoryboardTemplate","@/__tests__/floatingPanelChatNoSlashInvocationContract.test","testAgenticOsAttachedMediaResponsesUseStoryboardTemplateContract"],
  ...
  ["ui.floatingPanelChat.noSlash.whatsImageCleanSlate","@/__tests__/floatingPanelChatNoSlashInvocationContract.test","testAgenticOsNoSlashWhatsImagePromptStaysQueryResponsiveAndCleanSlate"],
  ["ui.floatingPanelChat.noSlash.structuredResponseYamlGate","@/__tests__/floatingPanelChatNoSlashInvocationContract.test","testAgenticOsNoSlashStructuredResponseRejectsDanglingFlowPatchYaml"],
  ...
  ["chat.responseContract.storage.agenticOsNewChatCollisionSessionFolder","@/__tests__/chatHistoryWorkspacePersistence.test","testChatHistoryWorkspaceNewAgenticOsCollisionCreatesMatchingSessionFolder"],
  ["chat.responseContract.storage.agenticOsTraceUserMediaSanitized","@/__tests__/chatHistoryWorkspacePersistence.test","testChatHistoryWorkspaceAgenticOsTraceSanitizesLocalMediaUserText"],
