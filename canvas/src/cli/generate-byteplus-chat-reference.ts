...
const OUTPUT_PATH = path.join(
  ...
  'docs',
  'documents',
  'agenticgraph-byteplus-openark-chat-api-reference.md',
)
const RAW_SSOT_PATH = 'docs/documents/agenticgraph-byteplus-openark-chat-api-reference-raw.md'
...
function buildMarkdown(): string {
  return [
    '# agenticgraph - BytePlus OpenArk Chat API Reference (SSOT + Codebase Map)',
    '',
    ...
    '',
    'Scope:',
    '- This static reference is intentionally limited to the BytePlus request-surface rows that agenticgraph exposes in `MainPanel Integrations`, `Workflow Manager`, and the `Widget Card` when configured for BytePlus.',
    '- `provider`, `auth_mode`, `endpoint_url`, and `api_key` are agenticgraph integration transport settings aligned to BytePlus ModelArk execution, not raw OpenArk body fields.',
    '',
    'Table columns:',
