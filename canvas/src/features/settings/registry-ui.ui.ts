...
export const uiUiSettingsRegistry: SettingMeta[] = [
  ...
  },
  {
    ...
    write: (v) => s().setChatStorageTarget(String(v || '').trim() === 'chatHistory' ? 'chatHistory' : 'chatAgenticGraph'),
    docKey: 'chatStorageTarget',
    default: () => 'chatAgenticGraph',
    options: ['chatAgenticGraph', 'chatHistory'],
  },
  {
  ...
  {
    key: 'chatAgenticGraphStorageMode',
    type: 'string',
    source: 'localStorage',
    read: () => s().chatAgenticGraphStorageMode,
    write: (v) => s().setChatAgenticGraphStorageMode(String(v || '').trim() === 'cloud' ? 'cloud' : 'local'),
    docKey: 'chatAgenticGraphStorageMode',
    default: () => 'local',
    options: ['local', 'cloud'],
  },
  {
    key: 'chatAgenticGraphWorkspacePath',
    type: 'string',
    source: 'localStorage',
    read: () => s().chatAgenticGraphWorkspacePath,
    write: (v) => s().setChatAgenticGraphWorkspacePath(String(v || '').trim() || null),
    docKey: 'chatAgenticGraphWorkspacePath',
    default: () => null,
  },
  {
    key: 'chatAgenticGraphCloudUrl',
    type: 'string',
    source: 'localStorage',
    read: () => s().chatAgenticGraphCloudUrl,
    write: (v) => s().setChatAgenticGraphCloudUrl(String(v || '').trim() || null),
    docKey: 'chatAgenticGraphCloudUrl',
    default: () => null,
  },
  {
