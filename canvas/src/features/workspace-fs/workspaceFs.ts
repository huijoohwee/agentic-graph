...
const REPO_LOCAL_RUN_READY_SOURCE_EXCLUSIVE = WORKSPACE_RUN_READY_DEMO?.sourceRoot === 'agentic-graph/docs'
...
export const DEFAULT_TEST_VALIDATION_WORKSPACE_SEED_BASENAME = 'agentic-graph-agentic-video-canvas-demo.md'
export const GEOSPATIAL_WORKSPACE_SEED_BASENAME = 'agentic-graph-maps-places.md'
...
const DEFAULT_WORKSPACE_README_TEXT = [
  '---',
  'title: "agentic-graph - Write it. See it. Ship it."',
