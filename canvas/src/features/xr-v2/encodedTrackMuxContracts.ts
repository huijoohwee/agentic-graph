export const XR_V2_ENCODED_TRACK_SET_SCHEMA = 'knowgrph-xr-v2-encoded-track-set/v1' as const
export const XR_V2_MUXED_CONTAINER_SCHEMA = 'knowgrph-xr-v2-muxed-container/v1' as const
