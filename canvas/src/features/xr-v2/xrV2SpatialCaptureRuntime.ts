...
export const XR_V2_SPATIAL_CAPTURE_RUNTIME_SCHEMA = 'agentic-graph-xr-v2-spatial-capture-runtime/v1' as const
...
function persistenceKeys(id: string): XrV2CapturePersistenceKeys {
  return Object.freeze({
    rawClipRef: `indexeddb://agentic-graph-xr-v2/raw-clip/${id}`,
    depthMetadataRef: `indexeddb://agentic-graph-xr-v2/frame-bundle/${id}`,
