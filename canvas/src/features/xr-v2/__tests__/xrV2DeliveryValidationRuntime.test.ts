...
function encodedFixture(): XrV2SavedAssetEncodedTrackFixture {
  return {
    ...
    inventory: {
      schema: 'agentic-graph-xr-v2-container-inventory/v1',
      container: 'webm',
    ...
    sourceRawClipRef: 'indexeddb://agentic-graph-xr-v2/raw-clip/saved-capture',
    sourceRawClipMimeType: 'video/webm',
    sourceRawClipByteSize: 3,
    sourceRawClipSha256: `sha256:${'0'.repeat(64)}`,
    sourceDepthMetadataRef: 'indexeddb://agentic-graph-xr-v2/frame-bundle/saved-capture',
...
function savedResource(): XrV2SavedSpatialAssetResource {
  return {
    asset: {
      ...
      raw_clip_ref: 'indexeddb://agentic-graph-xr-v2/raw-clip/saved-capture',
      metadata: { depth_metadata_ref: 'indexeddb://agentic-graph-xr-v2/frame-bundle/saved-capture' },
    },
