...
export const MAIN_PANEL_WORKFLOW_LINKS_DOC_PATH = 'docs/documents/agentic-graph-mainpanel-workflow-links.md'
...
export async function loadMainPanelWorkflowLinkTexts(): Promise<Record<string, MainPanelWorkflowLinkText>> {
  try {
    const markdownModule = await import('../../../../docs/documents/agentic-graph-mainpanel-workflow-links.md?raw') as { default?: string }
