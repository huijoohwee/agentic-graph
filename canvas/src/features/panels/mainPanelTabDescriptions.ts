...
export const MAIN_PANEL_TAB_DESCRIPTIONS_DOC_PATH = 'docs/documents/agentic-graph-mainpanel-tabs.md'
...
export async function loadMainPanelTabDescriptionRows(): Promise<ParsedTabDescriptionRow[]> {
  try {
    const markdownModule = await import('../../../../docs/documents/agentic-graph-mainpanel-tabs.md?raw') as { default?: string }
