...
export const MAIN_PANEL_SECTION_DESCRIPTIONS_DOC_PATH = 'docs/documents/agentic-graph-mainpanel-section-descriptions.md'
...
declare const __AGENTIC_OS_MAIN_PANEL_SECTION_DESCRIPTIONS_MARKDOWN__: string | undefined
type MainPanelSectionDescriptionsGlobalScope = typeof globalThis & {
  __AGENTIC_OS_MAIN_PANEL_SECTION_DESCRIPTIONS_MARKDOWN__?: string
}

function readBundledMainPanelSectionDescriptionsMarkdown(): string {
  if (
    typeof __AGENTIC_OS_MAIN_PANEL_SECTION_DESCRIPTIONS_MARKDOWN__ === 'string'
    && __AGENTIC_OS_MAIN_PANEL_SECTION_DESCRIPTIONS_MARKDOWN__.trim()
  ) {
    return __AGENTIC_OS_MAIN_PANEL_SECTION_DESCRIPTIONS_MARKDOWN__
  }
  const globalMarkdown = (globalThis as MainPanelSectionDescriptionsGlobalScope).__AGENTIC_OS_MAIN_PANEL_SECTION_DESCRIPTIONS_MARKDOWN__
