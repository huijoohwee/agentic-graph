...
export const VISUAL_ANNOTATION_DATASET_SCHEMA_VERSION = 'agentic-graph-visual-annotation-dataset/v1' as const
export const VISUAL_ZONE_COUNTING_SCHEMA_VERSION = 'agentic-graph-zone-counting/v1' as const
