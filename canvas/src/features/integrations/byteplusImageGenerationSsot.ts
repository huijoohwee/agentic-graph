...
export const BYTEPLUS_IMAGE_GENERATION_DOC_ROWS: ReadonlyArray<BytePlusImageApiDocRow> = [
  ...
  },
  {
    ...
    valueDescription: 'Default: https://docs.byteplus.com/en/docs/ModelArk/1666945; Opening the vendor docs expands source context; staying inside agenticgraph narrows attention to the curated request surface.',
    ssot: BYTEPLUS_IMAGE_GENERATION_API_DOCS_URL,
    module: ['canvas/src/features/panels/views/SettingsView.tsx', 'docs/documents/agenticgraph-byteplus-openark-image-generation-api-reference.md'],
  ...
  },
  {
    ...
    notes: 'AgenticGraph routes this through the proxy and keeps binary decoding on the shared image pipeline.',
  },
  {
    key: 'guidance_scale',
    typeLabel: 'number',
  ...
  },
  {
    ...
    notes: 'AgenticGraph maps widget `reference_image` into the upstream `image` field.',
  },
  {
    key: 'output_format',
    typeLabel: 'string',
  ...
  },
  {
    ...
    responsibility: 'Selects the BytePlus image response format used by agenticgraph.',
