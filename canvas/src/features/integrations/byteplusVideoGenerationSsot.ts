...
export const BYTEPLUS_VIDEO_GENERATION_DOC_ROWS: ReadonlyArray<BytePlusVideoApiDocRow> = [
  ...
  },
  {
    ...
    valueDescription: 'Default: false; Enabling camera_fixed expands stable camera motion; in agentic-graph this flag is only sent for image-conditioned video runs (i2v).',
    ...
    tooltipDefaultValue: false,
    tooltipExpansionNote: 'Enabling camera_fixed expands stabilized camera behavior; agentic-graph sends this only for image-conditioned video runs (i2v).',
  ...
  },
  {
    ...
    valueDescription: 'Default: https://api.byteplus.com/api-explorer/?action=CreateContentsGenerationsTasks&groupName=Video%20Generation%20API&serviceCode=ark&version=2024-01-01; Opening the vendor docs expands source context; staying inside agentic-graph narrows attention to the curated request surface.',
    ssot: BYTEPLUS_VIDEO_GENERATION_API_DOCS_URL,
    module: ['canvas/src/features/panels/views/SettingsView.tsx', 'docs/documents/agentic-graph-byteplus-openark-video-generation-api-reference.md'],
  ...
  },
  {
    ...
    notes: 'agentic-graph routes this through the proxy and sets the upstream origin internally.',
  },
  {
  ...
  },
  {
    ...
    notes: 'agentic-graph uses this field when content_json is empty.',
  },
]
