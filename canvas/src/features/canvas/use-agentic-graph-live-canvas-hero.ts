...
const LIVE_CANVAS_HERO_INITIALIZATION_SOURCE_BASENAME = 'agentic-graph-agentic-video-canvas-demo.md'
...
export function useAgenticGraphLiveCanvasHero(args: {
  ...
  // Home's background source only; it must never promote /agentic-graph into Home.
  React.useEffect(() => {
