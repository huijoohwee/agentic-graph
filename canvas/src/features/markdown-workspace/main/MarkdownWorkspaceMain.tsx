  ...
  return (
    <MarkdownWorkspaceLayout
      toolbarProps={{
        ...
        setSplitPaneVisibility,
        paneAvailability,
        onSaveAs: props.exportEnabled === false ? undefined : onSaveAs,
        onExportWorkspaceFile: props.exportEnabled === false ? undefined : handleExportWorkspaceFile,
        onExportMarkdown: props.exportEnabled === false ? undefined : handleExportMarkdown,
        onExportHtmlViewer: props.exportEnabled === false ? undefined : handleExportHtmlViewer,
        onExportHtmlCanvas: props.exportEnabled === false ? undefined : handleExportHtmlCanvas,
        onExportJson: props.exportEnabled === false ? undefined : handleExportJson,
        onExportSvg: props.exportEnabled === false ? undefined : handleExportSvg,
        onToggleFullscreen,
        presentationApiRef,
