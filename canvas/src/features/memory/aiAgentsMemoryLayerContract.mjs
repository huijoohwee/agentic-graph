export const AGENTIC_OS_MEMORY_LAYER_CONTRACT_VERSION = "agentic-graph-memory-layer/v0.1";

export const AGENTIC_OS_MEMORY_LAYER_DEFAULT_TOP_K = 10;
export const AGENTIC_OS_MEMORY_LAYER_DEFAULT_MAX_MEMORY_TOKENS = 500;

export const AGENTIC_OS_MEMORY_LAYER_PROVIDER_MODES = Object.freeze([
  "local-json",
  "mem0-platform",
  "mem0-oss",
  "external-mcp",
...
export const AGENTIC_OS_MEMORY_LAYER_MCP_TOOL_NAMES = Object.freeze({
  add: "agentic-graph.memory.add",
  search: "agentic-graph.memory.search",
  assemblePrompt: "agentic-graph.memory.assemble_prompt",
  extractProcedural: "agentic-graph.memory.extract_procedural",
  materializeUserModel: "agentic-graph.memory.materialize_user_model",
});

export const AGENTIC_OS_MEMORY_LAYER_ENV = Object.freeze({
  storePath: "AGENTIC_OS_MEMORY_STORE_PATH",
  providerMode: "AGENTIC_OS_MEMORY_PROVIDER_MODE",
...
export const MEMORY_SEARCH_INPUT_SCHEMA = Object.freeze({
  ...
  properties: {
    ...
    run_id: { type: "string", description: "Runtime run/session scope." },
    app_id: { type: "string", description: "Runtime app/workspace scope." },
    top_k: { type: "number", default: AGENTIC_OS_MEMORY_LAYER_DEFAULT_TOP_K },
...
export const PROMPT_ASSEMBLER_INPUT_SCHEMA = Object.freeze({
  ...
  properties: {
    ...
    max_memory_tokens: { type: "number", default: AGENTIC_OS_MEMORY_LAYER_DEFAULT_MAX_MEMORY_TOKENS },
  },
});
...
export const buildMemoryCostLog = ({ provider, operation, latencyMs }) => ({
  provider: AGENTIC_OS_MEMORY_LAYER_PROVIDER_MODES.includes(provider) ? provider : "local-json",
  operation,
