...
export const AGENTIC_OS_DOCS_MCP_BRIDGE_PATH = '/__agentic_graph_mcp_agentic_os_docs_invoke' as const
export const AGENTIC_OS_DOCS_MCP_TOOL_NAME = 'agentic-graph.agentic_canvas_os.docs.invoke' as const
