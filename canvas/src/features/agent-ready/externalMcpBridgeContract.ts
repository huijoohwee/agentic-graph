export const EXTERNAL_MCP_CATALOG_PATH = '/__agentic_graph_external_mcp/catalog' as const
export const EXTERNAL_MCP_PREPARE_PATH = '/__agentic_graph_external_mcp/prepare' as const
export const EXTERNAL_MCP_CALL_PATH = '/__agentic_graph_external_mcp/call' as const
