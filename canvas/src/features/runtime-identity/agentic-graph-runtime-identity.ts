...
declare const __AGENTIC_OS_RUNTIME_DEVICE__: string | undefined
declare const __AGENTIC_OS_SOURCE_BRANCH__: string | undefined
...
export const readAgenticGraphSourceRevision = (): string => readBuildConstant(
  typeof __AGENTIC_OS_SOURCE_REVISION__ === 'string' ? __AGENTIC_OS_SOURCE_REVISION__ : '',
)

export const readAgenticGraphRuntimeDevice = (): string => readBuildConstant(
  typeof __AGENTIC_OS_RUNTIME_DEVICE__ === 'string' ? __AGENTIC_OS_RUNTIME_DEVICE__ : 'unknown-device',
) || 'unknown-device'

export const readAgenticGraphSourceBranch = (): string => readBuildConstant(
  typeof __AGENTIC_OS_SOURCE_BRANCH__ === 'string' ? __AGENTIC_OS_SOURCE_BRANCH__ : 'unknown',
) || 'unknown'
