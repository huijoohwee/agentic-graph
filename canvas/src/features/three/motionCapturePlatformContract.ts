...
export const MOTION_CAPTURE_PLATFORM_SCHEMA = 'agentic-graph.motion-capture-platform/v1' as const
export const MOTION_CAPTURE_RECORDING_SCHEMA = 'agentic-graph.motion-capture-recording/v1' as const
...
export type MotionCaptureCalibrationResearchValidation = Readonly<{
  schema: 'agentic-graph.motion-capture-calibration-validation/v1'
...
export type MotionCaptureReconstructionResearchValidation = Readonly<{
  schema: 'agentic-graph.motion-capture-reconstruction-validation/v1'
  researchManifestDigestSha256: string
  referenceFrame: 'metric-si-right-up-forward'
...
export type MotionCaptureExportArtifact = Readonly<{
  schema: 'agentic-graph.motion-capture-export/v1'
