...
export interface GraphStateChatImport {
  ...
  chatStorageTarget: 'chatAgenticGraph' | 'chatHistory';
  setChatStorageTarget: (target: 'chatAgenticGraph' | 'chatHistory') => void;
  chatLocalStorageRootPath: string;
  setChatLocalStorageRootPath: (path: string | null) => void;
  chatAgenticGraphStorageMode: 'local' | 'cloud';
  setChatAgenticGraphStorageMode: (mode: 'local' | 'cloud') => void;
  chatAgenticGraphWorkspacePath: string | null;
  setChatAgenticGraphWorkspacePath: (path: string | null) => void;
  ...
  setChatAgenticGraphCloudUrl: (url: string | null) => void;
