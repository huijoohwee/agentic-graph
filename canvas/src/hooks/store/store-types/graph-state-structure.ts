...
export interface GraphStateStructure {
  ...
  createUserSubgraph: (args: { label?: string; memberNodeIds: string[]; parentId?: string | null; kind?: 'subgraph' | 'cluster'; autoBounds?: boolean }) => { ok: true; id: string } | { ok: false; message: string };
