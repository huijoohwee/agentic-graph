...
export async function testAgentGraphBrowserHostParserRegistryDigestBoundary() {
  ...
  try {
    ...
    const request = async () => fetch(`http://127.0.0.1:${address.port}/__agentic_graph_agent_graph/repositories`, {
      method: 'POST',
