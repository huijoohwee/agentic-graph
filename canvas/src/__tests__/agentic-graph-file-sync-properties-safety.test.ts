...
} from "./agentic-graph-file-sync-properties-core.test";

const PROPERTY_RUNS = 100;

// Feature: agentic-graph-storage-sync-enhancement, Property 53: Outbox capacity is atomic.
...
// Feature: agentic-graph-storage-sync-enhancement, Property 54: Offline replay is FIFO with 1s/2s, max-three retry ownership.
...
// Feature: agentic-graph-storage-sync-enhancement, Property 55: Errors and durable state exclude credentials.
...
// Feature: agentic-graph-storage-sync-enhancement, Property 56: Runtime and entry-type boundaries fail closed.
