...
const CLOUD_AGENTICGRAPH_URL = 'https://cloud.example/agenticgraph-overlap-cloud.md'
const CLOUD_HISTORY_URL = 'https://cloud.example/history-overlap-cloud.md'
const LOCAL_AGENTICGRAPH_FILE_NAME = 'kgc_20260523171500.md'
...
export async function testSettingsCloudThenLocalImportKeepsCommittedSurfaceTruthfulWhileLatestDraftWins() {
  ...
  try {
    ...
    store.setChatAgenticGraphCloudUrl('https://cloud.example/agenticgraph-before-cloud-local.md')
    ...
    if (agenticgraphStatus !== LOCAL_AGENTICGRAPH_PATH || historyStatus !== LOCAL_HISTORY_PATH) {
    ...
    if (
      ...
      preApplyInspection.cloudUrls.chatAgenticGraphCloudUrl !== 'https://cloud.example/agenticgraph-before-cloud-local.md' ||
