...
// Feature: knowgrph-game-flight-sim, Property 40 - Source-authored activation identity with fail-closed conflicts
test('Feature: knowgrph-game-flight-sim, Property 40 - Source-authored activation identity with fail-closed conflicts', () => {
  fc.assert(
    fc.property(
