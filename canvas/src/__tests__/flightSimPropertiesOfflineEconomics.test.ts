...
// Feature: agentic-graph-game-flight-sim, Property 1 - Zero external calls during runtime
test('Feature: agentic-graph-game-flight-sim, Property 1 - Zero external calls during runtime', async () => {
  await fc.assert(
    fc.asyncProperty(
...
// Feature: agentic-graph-game-flight-sim, Property 2 - Blocked gameplay/inference attempt fails closed and preserves state
test('Feature: agentic-graph-game-flight-sim, Property 2 - Blocked gameplay/inference attempt fails closed and preserves state', async () => {
  await fc.assert(
    fc.asyncProperty(
...
// Feature: agentic-graph-game-flight-sim, Property 3 - Successful model-free tick emits exactly one canonical zero Cost_Log
test('Feature: agentic-graph-game-flight-sim, Property 3 - Successful model-free tick emits exactly one canonical zero Cost_Log', async () => {
  await fc.assert(
    fc.asyncProperty(
...
// Feature: agentic-graph-game-flight-sim, Property 4 - Decisions-only persistence path
test('Feature: agentic-graph-game-flight-sim, Property 4 - Decisions-only persistence path', async () => {
  await fc.assert(
    fc.asyncProperty(
