...
export function testStrybldrImportImageAndStoryboardOwnersAreWired() {
  ...
  assert(choiceText.includes('createStoryboardForImportedImage'), 'expected storyboard creation only after the user selects it')
  assert(choiceText.includes('buildStrybldrStoryboardDocument'), 'expected the selected storyboard to use the feature owner')
