...
test('agentic-graph Git codec uses the canonical loose-object type and byte-length header', async () => {
...
test('agentic-graph Git tree parser rejects truncated, symlink, and submodule forms', () => {
...
test('agentic-graph Git commit parser verifies required canonical references', async () => {
