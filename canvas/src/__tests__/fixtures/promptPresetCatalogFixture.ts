...
export const promptCatalogMarkdown = [
  ...
  '    description: Shared physics controller demo.',
  ...
  '    prompt: "/xr.physics @canvas #controller operation=develop-run mode=ball"',
  '  - id: "launch-copilot"',
  '    label: "Launch Copilot (81rv10)"',
  '    slash_command: "/launch-copilot-prompt-preset"',
  '    runtime_command: "/launch-copilot"',
  '    description: "Pain point to grounded MVP and GTM proposal. Import a source and select its cluster first."',
  ...
  '    prompt: |-',
  '      /launch-copilot outline reference Assess a solopreneur checkout pain point using the selected source.',
  '  - id: "video-agent"',
  '    label: "Video Agent"',
