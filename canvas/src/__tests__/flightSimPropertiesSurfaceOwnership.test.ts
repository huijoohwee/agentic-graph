...
// Feature: agentic-graph-game-flight-sim, Property 39 - Canvas ownership preserved across enter/exit and failures
test('Feature: agentic-graph-game-flight-sim, Property 39 - Canvas ownership preserved across enter/exit and failures', async () => {
  const dom = new JSDOM(
