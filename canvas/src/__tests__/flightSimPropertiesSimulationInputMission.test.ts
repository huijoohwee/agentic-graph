...
// Feature: agentic-graph-game-flight-sim, Property 13 - Flight integration stays finite and bounded
test('Feature: agentic-graph-game-flight-sim, Property 13 - Flight integration stays finite and bounded', () => {
  fc.assert(
...
// Feature: agentic-graph-game-flight-sim, Property 14 - Input clamping to valid ranges
test('Feature: agentic-graph-game-flight-sim, Property 14 - Input clamping to valid ranges', () => {
  fc.assert(
    fc.property(
...
// Feature: agentic-graph-game-flight-sim, Property 15 - Swept AABB collision yields a non-penetrating result
test('Feature: agentic-graph-game-flight-sim, Property 15 - Swept AABB collision yields a non-penetrating result', () => {
  fc.assert(
    fc.property(
...
// Feature: agentic-graph-game-flight-sim, Property 16 - Earliest-hit selection with stable tie-break
test('Feature: agentic-graph-game-flight-sim, Property 16 - Earliest-hit selection with stable tie-break', () => {
  fc.assert(
    fc.property(
      finiteDouble(2, 6),
      finiteDouble(1, 4),
...
// Feature: agentic-graph-game-flight-sim, Property 17 - Start-of-tick penetration is resolved
test('Feature: agentic-graph-game-flight-sim, Property 17 - Start-of-tick penetration is resolved', () => {
  fc.assert(
    fc.property(
      fc.integer({ min: 0, max: 2 }),
      fc.constantFrom(-1, 1),
...
// Feature: agentic-graph-game-flight-sim, Property 22 - Normalized input frame composition
test('Feature: agentic-graph-game-flight-sim, Property 22 - Normalized input frame composition', () => {
  fc.assert(
    fc.property(
...
// Feature: agentic-graph-game-flight-sim, Property 24 - Ordered waypoint progression to terminal success
test('Feature: agentic-graph-game-flight-sim, Property 24 - Ordered waypoint progression to terminal success', async () => {
  await fc.assert(
