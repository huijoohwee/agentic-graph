...
export function testXrShootWorkflowMarksRigsRetimeAndExports() {
  ...
  for (const marker of ['xr-camera-motion-retime-lane-label', 'xr-camera-motion-retime-lane-mark', 'position: absolute', 'inset: 0', 'top: 50%', 'transform: translate(-50%, -50%)', 'cursor: ew-resize', 'xr-camera-motion-mark-selection-controls--lane', '--kg-xr-mark-editor-translate-x', '[aria-pressed="true"]', 'xr-shot-target-timeline-bar', 'data-kg-xr-shot-target-selected', 'xr-timeline-scene-stage-control--selected', 'xr-timeline-scene-stage-button', 'xr-timeline-scene-stage-options', 'xr-timeline-scene-stage-option', '[data-kg-gantt-timeline-track-row-key*="xr_stage_scene"].timeline-transport-track-clip--selected .timeline-transport-track-clip-label', 'visibility: hidden']) {
  ...
  for (const forbidden of ['layout="controls"', 'layout="ruler"', 'layout="time-axis"', 'supplementalLanes={', "id: 'xr-control'", 'stage-output', 'selectedStagePreset', 'SCENE · {', '<PanelSelect', '<option key={preset.id} value={preset.id}>', 'xr-timeline-scene-stage-select', 'data-kg-xr-motion-scene-controls="compact"', 'data-kg-xr-timeline-shot-target="individual-lane"', 'data-kg-xr-timeline-consolidated-lane="stage-output-ruler"', 'data-kg-xr-motion-stage-buttons="1"', 'data-kg-xr-motion-stage-button={preset.id}', 'data-kg-xr-motion-stage-select="1"', 'data-kg-xr-motion-stage-field="1"', 'data-kg-xr-timeline-playhead-control="1"', 'data-kg-xr-motion-stage-summary="1"', 'data-kg-xr-timeline-control-bar="marks"', 'timeRulerOverlay={<CameraMotionMarkRetime', '--kg-xr-timeline-marks-height', '>Marks</span>']) {
  ...
  const sceneClipControlSource = timelineSource.slice(sceneClipControlStart, timelineSource.indexOf('data-kg-xr-motion-scene-control-row="stage-summary"', sceneClipControlStart))
