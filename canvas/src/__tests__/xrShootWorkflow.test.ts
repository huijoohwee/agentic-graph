...
export function testXrShootWorkflowMarksRigsRetimeAndExports() {
  ...
  for (const forbidden of ['layout="controls"', 'layout="ruler"', 'layout="time-axis"', 'supplementalLanes={', "id: 'xr-control'", 'stage-output', 'selectedStagePreset', 'SCENE · {', '<PanelSelect', '<option key={preset.id} value={preset.id}>', 'xr-timeline-scene-stage-select', 'data-kg-xr-motion-scene-controls="compact"', 'data-kg-xr-motion-scene-controls="expanded"', 'data-kg-xr-motion-scene-control-row=', 'xr-timeline-scene-stage-row', 'data-kg-xr-timeline-shot-target="individual-lane"', 'data-kg-xr-timeline-consolidated-lane="stage-output-ruler"', 'data-kg-xr-motion-stage-buttons="1"', 'data-kg-xr-motion-stage-button={preset.id}', 'data-kg-xr-motion-stage-select="1"', 'data-kg-xr-motion-stage-field="1"', 'data-kg-xr-timeline-playhead-control="1"', 'data-kg-xr-motion-stage-summary="1"', 'data-kg-xr-timeline-control-bar="marks"', 'timeRulerOverlay={<CameraMotionMarkRetime', '--kg-xr-timeline-marks-height', '>Marks</span>']) {
