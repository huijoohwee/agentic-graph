...
export function testXrShootWorkflowMarksRigsRetimeAndExports() {
  ...
  for (const marker of ["laneTarget?.kind === 'cast'", "laneTarget?.kind === 'camera'", 'data-kg-xr-choreography-cast-lane', 'data-kg-xr-choreography-camera-lane', 'data-kg-xr-choreography-lane-axis', 'beginRulerMarkDrag', 'resolveVideoSequenceRulerInsetPixelMetrics', 'XrChoreographyMarkControls', 'compact showPosition', 'applyXrConstrainedCastMarkChoreography', 'setXrMotionReferenceCameraMarkChoreography', 'data-kg-xr-ruler-mark-editor', 'data-kg-xr-speed-warning-count', 'XR_ANIMATION_PRESETS.filter(preset => xrAnimationPresetCompatible', "controlXrSharedAssetControls({", "operation: 'apply-animation'", 'data-kg-xr-mark-animation-presets="click-appear"', 'data-kg-xr-mark-animation-preset-select={selectedCastMark.id}', '<PanelSelect', '<option key={preset.id} value={preset.id}>', 'data-kg-xr-shared-asset-actions="individual-lane"', 'data-kg-xr-shared-asset-action-cluster="individual-lane"', 'data-kg-xr-shared-asset-animate="individual-lane"', 'data-kg-xr-shared-asset-clear-animation="individual-lane"', 'data-kg-xr-shared-asset-gesture-mark="individual-lane"', 'data-kg-xr-shared-asset-hand-keyframe="individual-lane"', 'data-kg-xr-shared-asset-playback="individual-lane"', 'data-kg-xr-shared-asset-playback-owner="individual-lane"', "runSelectedCastSharedAssetAction('capture-hand-pose')", 'xrMotionReferenceTimelineDocumentKey']) {
