...
} from '@/lib/storage/agentic-graph-storage-git-save-bridge'
import {
...
const documents: AgenticGraphGitResolvedDocument[] = [
  {
    path: 'agentic-graph/docs/alpha.md',
    kind: 'markdown',
    text: '# Alpha\n',
    canonicalPath: 'agentic-graph/docs/alpha.md',
    repositoryPath: 'docs/alpha.md',
    repositoryId: 'agentic-graph-docs',
  },
  {
    path: 'agentic-graph/docs/beta.json',
    kind: 'json',
    text: '{"beta":true}',
    canonicalPath: 'agentic-graph/docs/beta.json',
