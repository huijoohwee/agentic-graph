...
export function testXrSpatialCaptureFallbackBrowserSmokeContract() {
  ...
  const testingDocumentation = readFileSync(new URL('../../../docs/documents/knowgrph-testing-document.md', import.meta.url), 'utf8')
  const readinessDocumentation = readFileSync(new URL('../../../docs/documents/knowgrph-xr-spatial-capture-fallback-readiness.md', import.meta.url), 'utf8')
  const runtimeApiDocumentation = readFileSync(new URL('../../../docs/documents/knowgrph-xr-invocation-runtime-api.md', import.meta.url), 'utf8')
