...
import { AGENTIC_OS_STORAGE_API_VERSION, AGENTIC_OS_STORAGE_SYNC_LIMITS } from '@/lib/storage/agentic-graph-storage-sync-contract'
import {
...
export async function testAgenticGraphStorageClientAppliesEveryKeysetPage() {
  ...
  const fetchImpl: typeof fetch = async (input, init) => {
    ...
    return Response.json({
      ok: true, apiVersion: AGENTIC_OS_STORAGE_API_VERSION, workspaceId,
