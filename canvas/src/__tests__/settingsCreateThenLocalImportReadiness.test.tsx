...
const CREATED_AGENTIC_OS_PATH = '/workspace/chat/20260523T170000Z/agenticOs_20260523T170000Z.md'
const CREATED_HISTORY_PATH = '/workspace/chat/chh_20260523170000.md'
const IMPORTED_AGENTIC_OS_FILE_NAME = 'agenticOs_20260523170100.md'
...
export async function testSettingsCreateThenLocalImportKeepsCommittedSurfaceTruthfulWhileLatestDraftWins() {
  ...
  try {
    ...
    Date.now = () => Date.UTC(2026, 4, 23, 17, 0, 0, 0)
    ...
    store.setChatAgenticGraphCloudUrl('https://cloud.example/agentic-graph-before-create-import.md')
    ...
    await mountReactRoot(settingsRoot, React.createElement(SettingsCreateThenLocalImportHarness, { actionsRef, asyncActions }), {
    ...
    if (
      ...
      draftAgenticGraphWorkspacePath !== IMPORTED_AGENTIC_OS_PATH ||
    ...
    if (agenticGraphStatus !== IMPORTED_AGENTIC_OS_PATH || historyStatus !== IMPORTED_HISTORY_PATH) {
    ...
    if (
      ...
      preApplyInspection.cloudUrls.chatAgenticGraphCloudUrl !== 'https://cloud.example/agentic-graph-before-create-import.md' ||
    ...
    if (
      ...
      appliedInspection.workspacePaths.chatAgenticGraphWorkspacePath !== IMPORTED_AGENTIC_OS_PATH ||
    ...
    if (
      useGraphStore.getState().chatAgenticGraphWorkspacePath !== IMPORTED_AGENTIC_OS_PATH ||
