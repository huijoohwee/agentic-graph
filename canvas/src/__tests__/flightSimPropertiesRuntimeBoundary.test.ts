...
// Feature: agentic-graph-game-flight-sim, Property 23 - Motion_Control is optional input only
test('Feature: agentic-graph-game-flight-sim, Property 23 - Motion_Control is optional input only', () => {
  fc.assert(
    fc.property(
