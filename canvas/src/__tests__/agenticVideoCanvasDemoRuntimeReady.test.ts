...
const DOC_PATH = resolveRepoSourcePath(path.join('docs/workspace-seeds', 'agentic-graph-agentic-video-canvas-demo.md'))
...
export async function testAgenticVideoCanvasDemoIsExecutableAndReplayable() {
  ...
  const parsedGraph = tryParseMarkdownFrontmatterFlowGraph('agentic-graph-agentic-video-canvas-demo.md', markdownText)
