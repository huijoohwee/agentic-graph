...
export function testStoryboardWidgetFloatingPanelReusesSharedFloatingPanelAndKtvChrome() {
  ...
  const selectionTransportText = readFileSync(resolve(root, 'src/features/gitgraph/useGanttFloatingPanelSelectionTransportSync.ts'), 'utf8')
  if (!timelineFloatingText.includes('useGanttFloatingPanelSelectionTransportSync({') || !ganttFloatingText.includes('useGanttFloatingPanelSelectionTransportSync({') || !selectionTransportText.includes('onSelectedRowKeyChange(rowKey)')) throw new Error('expected both floating timeline adapters to forward selection to their shared bridge')
  ...
  if (!diagramBridgeText.includes('readDiagramSelectionLabels')
    ...
    || !timelineBottomText.includes('useStoryboardWidgetDiagramSelectionBridge') || !timelineBottomText.includes('onSelectedRowKeyChange={handleDiagramSelectedRowKeyChange}')
    ...
    || !timelineFloatingText.includes('onSelectedRowKeyChange: handleGanttDiagramSelectedRowKeyChange') || !timelineFloatingText.includes('onSelectedRowKeyChange={handleGanttSelectedRowKeyChange}')
    ...
    || !ganttFloatingText.includes('onSelectedRowKeyChange: handleDiagramSelectedRowKeyChange') || !ganttFloatingText.includes('onSelectedRowKeyChange={handleSelectedRowKeyChange}')
