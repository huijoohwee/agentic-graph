...
export async function testAgentGraphSkillsCommandsResolverUsesSharedSourceBackedCatalog() {
  resetSkillsCommandsMcpTargetForTests()
  resetAgenticOsRemoteGrammarCatalogForTests()
...
export async function testAgentGraphSkillsCommandsResolverRequiresRoutingProof() {
  resetSkillsCommandsMcpTargetForTests()
  resetAgenticOsRemoteGrammarCatalogForTests()
  const fetchMock = installSourceCatalogFetchMock({ includeRoutingProof: false })
  try {
    await assert.rejects(
      targetSkillsCommandsMcpInvocation(AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.agentGraphIngest),
...
export async function testAgentGraphLaunchImportUrlTargetsFloatingPanelSkillsCommands() {
  resetSkillsCommandsMcpTargetForTests()
  resetAgenticOsRemoteGrammarCatalogForTests()
  const fetchMock = installSourceCatalogFetchMock()
...
export async function testAgentGraphLaunchSkillsCommandsFailureIsVisibleAndScoped() {
  resetSkillsCommandsMcpTargetForTests()
  resetAgenticOsRemoteGrammarCatalogForTests()
  const originalFetch = globalThis.fetch
...
export async function testAgentGraphSkillsCommandsTargetClearsAcrossStoreOwnedShellExits() {
  resetSkillsCommandsMcpTargetForTests()
  resetAgenticOsRemoteGrammarCatalogForTests()
  const originalFetch = globalThis.fetch
