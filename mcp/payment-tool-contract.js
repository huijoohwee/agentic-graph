...
export const PAYMENT_TOOL_NAMES = Object.freeze({
  railSelect: AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.paymentRailSelect,
  intentCreate: AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.paymentIntentCreate,
  status: AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.paymentStatus,
  eventSettle: AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.paymentEventSettle,
  reconcile: AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.paymentReconcile,
  receiptProject: AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.paymentReceiptProject,
  refund: AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.paymentRefund,
  readiness: AGENTIC_OS_LOCAL_MCP_TOOL_NAMES.paymentReadiness,
});
...
const CAPABILITY_SCHEMA = Object.freeze({
  ...
  properties: {
    schemaVersion: { type: "string", const: "agentic-graph-payment-capability/v1" },
