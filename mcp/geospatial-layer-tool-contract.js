export const AGENTIC_OS_GEOSPATIAL_MCP_TOOL_NAMES = Object.freeze({
  command: "agentic-graph.geospatial.command",
});
...
export const buildGeospatialLayerToolDefinition = (toolName = AGENTIC_OS_GEOSPATIAL_MCP_TOOL_NAMES.command) => ({
  name: toolName,
