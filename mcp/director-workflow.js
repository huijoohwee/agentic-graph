// Director AgentWorkflow skeleton (agentic-graph-acos-mcp-connector spec, task 2.1).
//
//   Spec refs:
//     - R2.1: a single `agentic-graph.video_remix.run` tool accepting
...
// (`cloudflare/workers/agentic-graph-mcp/`) and Node `node:test` units without
...
export const DIRECTOR_TOOL_NAME = "agentic-graph.video_remix.run";

export const DIRECTOR_WORKFLOW_VERSION = "agentic-graph.director.workflow/v0.1";
 ...
 * Section-1 McpAgent boundary (`AGENTIC_OS_MCP_STAGE_GATES`) so the workflow
