import { AGENT_GRAPH_DECLARATIVE_GRAMMAR_SCHEMA_ID } from "../agent-graph-parser-contract.js";
import {
  compareStableStrings, AgentGraphError, sha256, spanFromOffsets, stableStringify,
} from "./contract.mjs";
...
const invalid = (message, details) => {
  throw new AgentGraphError("declarative_grammar_invalid", message, details);
};
...
function normalizeGrammar(raw) {
  ...
  if (raw.schema !== AGENT_GRAPH_DECLARATIVE_GRAMMAR_SCHEMA_ID) {
