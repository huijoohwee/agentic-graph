import { buildEvidence, makeEdge, makeNode, spanFromOffsets, stableEntityId, versionAgentGraphParserOutput } from "./contract.mjs";

export const SQL_PARSER_ID = "local-sql-structure";
export const SQL_PARSER_VERSION = versionAgentGraphParserOutput("1.0.0");
