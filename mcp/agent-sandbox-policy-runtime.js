...
export const AGENT_SANDBOX_POLICY_SCHEMA = "agentic-graph-agent-sandbox-policy/v1";
...
export async function runAgentSandboxPolicyTool(toolName, args, options = {}) {
  ...
  if (toolName === "agentic-graph.sandbox.policy.validate") return compiled;
  if (toolName === "agentic-graph.sandbox.policy.authorize") {
