export const AGENT_GRAPH_PARSER_REGISTRY_SCHEMA_ID =
  "agentic-graph-agent-graph-parser-registry/v2";

export const AGENT_GRAPH_DECLARATIVE_GRAMMAR_SCHEMA_ID =
  "agentic-graph-declarative-grammar/v1";

export const AGENT_GRAPH_DEFAULT_PARSER_PROFILE = "default-source";

export const NATIVE_AGENT_GRAPH_PARSER_ADAPTERS = Object.freeze({
...
export const NATIVE_AGENT_GRAPH_PARSER_ADAPTER_IDENTITIES = Object.freeze(
  Object.keys(NATIVE_AGENT_GRAPH_PARSER_ADAPTERS).sort(),
);
...
const AGENT_GRAPH_GRAMMAR_TERM_SCHEMA = Object.freeze({
  oneOf: [
    {
      type: "object",
...
export const AGENT_GRAPH_DECLARATIVE_GRAMMAR_SCHEMA = Object.freeze({
  type: "object",
  additionalProperties: false,
  required: ["schema", "start", "tokens", "rules"],
  properties: {
    schema: { const: AGENT_GRAPH_DECLARATIVE_GRAMMAR_SCHEMA_ID },
            ...
            items: {
              ...
              properties: {
                sequence: {
                  ...
                  minItems: 1,
                  maxItems: 64,
                  items: AGENT_GRAPH_GRAMMAR_TERM_SCHEMA,
                },
              },
            },
          },
...
const NATIVE_ADAPTER_FIDELITY_SCHEMA = Object.freeze({
  oneOf: Object.entries(NATIVE_AGENT_GRAPH_PARSER_ADAPTERS)
...
export const AGENT_GRAPH_PARSER_DESCRIPTOR_SCHEMA = Object.freeze({
  type: "object",
  additionalProperties: false,
  required: [
    "id",
  ...
  properties: {
    ...
    adapter: {
      type: "string",
      enum: NATIVE_AGENT_GRAPH_PARSER_ADAPTER_IDENTITIES,
    },
    fidelity: {
      type: "string",
      enum: [...new Set(Object.values(NATIVE_AGENT_GRAPH_PARSER_ADAPTERS))].sort(),
    },
    ...
    grammar: AGENT_GRAPH_DECLARATIVE_GRAMMAR_SCHEMA,
  },
  allOf: [
...
export const AGENT_GRAPH_PARSER_REGISTRY_SCHEMA = Object.freeze({
  type: "object",
  additionalProperties: false,
  required: ["schema", "digest", "descriptors"],
  properties: {
    schema: { const: AGENT_GRAPH_PARSER_REGISTRY_SCHEMA_ID },
    digest: { type: "string", pattern: "^[0-9a-f]{64}$" },
    descriptors: {
      type: "array",
      minItems: 1,
      maxItems: 128,
      items: AGENT_GRAPH_PARSER_DESCRIPTOR_SCHEMA,
    },
  },
});

export const AGENT_GRAPH_PARSER_GENERATE_INPUT_SCHEMA = Object.freeze({
  type: "object",
  additionalProperties: false,
  oneOf: [
  ...
  properties: {
    profile: {
      const: AGENT_GRAPH_DEFAULT_PARSER_PROFILE,
      description:
    ...
    descriptors: {
      ...
      maxItems: 128,
      items: {
        ...AGENT_GRAPH_PARSER_DESCRIPTOR_SCHEMA,
