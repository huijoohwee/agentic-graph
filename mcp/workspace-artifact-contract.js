export const WORKSPACE_ARTIFACT_PLAN_TOOL_NAME = "knowgrph.workspace_artifact.plan";
export const WORKSPACE_ARTIFACT_APPLY_TOOL_NAME = "knowgrph.workspace_artifact.apply";
