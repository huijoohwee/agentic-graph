export const REPOSITORY_PACK_TOOL_NAME = "knowgrph.repository.pack";
export const REPOSITORY_PACK_SCHEMA_VERSION = "knowgrph-repository-pack-result/v1";
export const REPOSITORY_PACK_FORMAT_VERSION = "knowgrph-repository-pack/v1";
