...
// (agentic-graph-acos-mcp-connector spec, task 2.5 - R2.1, R2.2 / Property 4).
//
// R2.2: IF a `agentic-graph.video_remix.run` call omits a required field, supplies
...
test("Property 4: a fully valid input produces a Run_Manifest", () => {
  ...
  assert.equal(payload.contractVersion, "agentic-graph.video_remix/v0.1");
