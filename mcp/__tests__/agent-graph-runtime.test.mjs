...
test("ingest writes content-addressed shards and returns only opaque graph identity", async (t) => {
  ...
  assert.deepEqual([pointer.schema, graph.snapshot.manifest.schema], ["agentic-graph-knowledge-graph-pointer/v1", "agentic-graph-knowledge-graph-sharded-manifest/v1"]);
