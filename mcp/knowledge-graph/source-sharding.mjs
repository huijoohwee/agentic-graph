...
export const KNOWLEDGE_GRAPH_SOURCE_BUNDLE_SCHEMA = "agentic-graph-knowledge-graph-source-bundle/v1";
export const KNOWLEDGE_GRAPH_SOURCE_PART_SCHEMA = "agentic-graph-knowledge-graph-source-part/v1";
...
function sourceLimitError(code, message, options, details = {}) {
  return new KnowledgeGraphError(code, message, {
