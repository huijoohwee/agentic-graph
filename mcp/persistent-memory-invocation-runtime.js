...
const INVOCATION_RESULT_SCHEMA = "agentic-graph-persistent-memory-invocation-result/v1";
const INVOCATION_RECEIPT_SCHEMA = "agentic-graph-persistent-memory-invocation-receipt/v1";
