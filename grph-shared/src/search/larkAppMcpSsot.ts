...
export const LARK_APP_MCP_DEPLOYED_URL = 'https://airvio.co/agentic-graph/mcp'

export const LARK_APP_MCP_DEFAULT_SERVER_KEY = 'agentic-graph'

export const LARK_APP_MCP_TRANSPORT_TYPE = 'streamable-http-jsonrpc'

export const LARK_APP_MCP_CANVAS_SURFACE = 'agentic-graph-canvas'
