...
export function requireXrV2RuntimeIdentity({ source, seedBasename, seedRelativePath }) {
  ...
  for (const [label, actual, expected] of [
    ...
    ['kgFloatingPanelView', frontmatter.kgFloatingPanelView, 'animation'], ['kgBottomPanelOpen', readBooleanPreset(frontmatter.kgBottomPanelOpen), true],
    ['kgBottomPanelTab', normalizePresetToken(frontmatter.kgBottomPanelTab), 'timeline'], ['run_ready_demo.id', runReady.id, 'xr-v2'],
