...
export function requireXrV2RuntimeIdentity({ source, seedBasename, seedRelativePath }) {
  ...
  for (const [label, actual, expected] of [
    ...
    ['run_ready_demo.canonical_source_file', runReady.canonical_source_file, `/${seedRelativePath}`], ['run_ready_demo.source_root', runReady.source_root, 'agenticgraph/docs'],
