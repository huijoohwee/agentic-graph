...
try {
  ...
  if (manifest.schemaId !== "agentic-graph-geospatial-readiness-properties/v1") {
...
const documentText = fs.readFileSync(
  path.join(root, "docs/documents/agentic-graph-geospatial-mode-document.md"),
  "utf8",
);
for (const requiredText of [
  "fill-extrusion",
  "agentic-graph.geospatial.command",
  "agentic-graph-geo-asset-mesh/v1",
