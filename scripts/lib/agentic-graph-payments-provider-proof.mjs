export const AGENTIC_OS_PAYMENTS_PROVIDER_PROOF_SCHEMA_ID =
  'agentic-graph-payments-provider-sandbox-proof/v1'
...
export function validateAgenticGraphPaymentsProviderProof(proof, expectedEvidenceDigest) {
  ...
  if (proof?.schemaId !== AGENTIC_OS_PAYMENTS_PROVIDER_PROOF_SCHEMA_ID) {
