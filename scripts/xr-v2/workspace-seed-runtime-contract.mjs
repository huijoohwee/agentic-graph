...
export const XR_V2_SHARED_SCENE_AUTHORITY = Object.freeze({
  id: 'xr-v2',
  sourceAuthority: '/docs/workspace-seeds/agenticgraph-physics-playground-demo.md',
...
export const requireXrV2RuntimeIdentity = ({ basename, relativePath, source }) => {
  ...
  for (const [label, actual, expected] of [
    ...
    ['run_ready_demo.canonical_source_file', runReady.canonical_source_file, `/${relativePath}`], ['run_ready_demo.source_root', runReady.source_root, 'agenticgraph/docs'],
    ...
    ['run_ready_demo.canonical_xr_world_owner', runReady.canonical_xr_world_owner, 'docs/workspace-seeds/agenticgraph-physics-playground-demo.md'],
    ...
    ['run_ready_demo.auto_start', readBooleanPreset(runReady.auto_start), true], ['pinned_source.path', pinned.path, 'docs/documents/agenticgraph-ar-vr-xr-prd-tad-adr.md'],
