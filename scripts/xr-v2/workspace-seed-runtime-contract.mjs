...
export const requireXrV2RuntimeIdentity = ({ basename, relativePath, source }) => {
  ...
  const flow = readKtvWorkspaceSeedFlow(basename, frontmatter.flow)
  ...
  for (const [label, actual, expected] of [
    ...
    ['run_ready_demo.canonical_source_file', runReady.canonical_source_file, `/${relativePath}`], ['run_ready_demo.source_root', runReady.source_root, 'agentic-graph/docs'],
