...
export const IMMUTABLE_RELEASE_MANIFEST_SCHEMA = 'agentic-graph.immutable-release-manifest/v1'
...
export const inspectImmutableReleaseSource = async ({
  ...
  const repository = resolveGitHubRepository(
    process.env.AGENTIC_OS_REPOSITORY || runGit(['remote', 'get-url', 'origin'], cwd),
  )
