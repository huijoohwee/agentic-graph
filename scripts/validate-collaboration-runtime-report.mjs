...
const classifyError = error => {
  ...
  if (message.startsWith('invalid agentic-graph.collaboration-runtime-report/')) {
...
const main = async () => {
  ...
  if (jsonOutput) {
    ...
    console.log(`[agentic-graph] collaboration runtime report passed (${result.schemaVersion})`)
  }
}
